...
static inline void loadSingle(const unsigned int Fn, target_ulong addr)
{
...
static inline void loadDouble(const unsigned int Fn, target_ulong addr)
{
    FPA11 *fpa11 = GET_FPA11();
    unsigned int *p;
...
static inline void loadExtended(const unsigned int Fn, target_ulong addr)
{
    FPA11 *fpa11 = GET_FPA11();
    unsigned int *p;
...
static inline void loadMultiple(const unsigned int Fn, target_ulong addr)
{
    FPA11 *fpa11 = GET_FPA11();
...
static inline void storeSingle(const unsigned int Fn, target_ulong addr)
{
    FPA11 *fpa11 = GET_FPA11();
    float32 val;
    ...
    case typeExtended:
        val =
            floatx80_to_float32(fpa11->fpreg[Fn].fExtended, &fpa11->fp_status);
        break;
...
static inline void storeDouble(const unsigned int Fn, target_ulong addr)
{
    FPA11 *fpa11 = GET_FPA11();
    float64 val;
    register unsigned int *p = (unsigned int *)&val;
    ...
    case typeExtended:
        val =
            floatx80_to_float64(fpa11->fpreg[Fn].fExtended, &fpa11->fp_status);
        break;
...
static inline void storeExtended(const unsigned int Fn, target_ulong addr)
{
    FPA11 *fpa11 = GET_FPA11();
    floatx80 val;
    register unsigned int *p = (unsigned int *)&val;
...
static inline void storeMultiple(const unsigned int Fn, target_ulong addr)
{
    FPA11 *fpa11 = GET_FPA11();
