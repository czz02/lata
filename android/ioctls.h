...
#endif
/* binder */
  IOCTL(BINDER_WRITE_READ,  IOC_RW,   MK_PTR(MK_STRUCT(STRUCT_binder_write_read)))
  IOCTL(BINDER_SET_IDLE_TIMEOUT, IOC_W, TYPE_LONG)
  IOCTL(BINDER_SET_MAX_THREADS, IOC_W, TYPE_INT)
  IOCTL(BINDER_SET_IDLE_PRIORITY, IOC_W, TYPE_INT)
  IOCTL(BINDER_SET_CONTEXT_MGR, IOC_W, TYPE_INT)
  IOCTL(BINDER_THREAD_EXIT, IOC_W, TYPE_INT)
  IOCTL(BINDER_VERSION, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_binder_version)))
  IOCTL(BINDER_GET_NODE_DEBUG_INFO, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_binder_node_debug_info)))
  IOCTL(BINDER_GET_NODE_INFO_FOR_REF, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_binder_node_info_for_ref)))
  IOCTL(BINDER_SET_CONTEXT_MGR_EXT, IOC_W, MK_PTR(MK_STRUCT(STRUCT_flat_binder_object)))
  IOCTL(BINDER_FREEZE, IOC_W, MK_PTR(MK_STRUCT(STRUCT_binder_freeze_info)))
  IOCTL(BINDER_GET_FROZEN_INFO, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_binder_frozen_status_info)))
  IOCTL(BINDER_ENABLE_ONEWAY_SPAM_DETECTION, IOC_W, TYPE_INT)
/* ashmem */
  IOCTL(ASHMEM_SET_NAME, IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, ASHMEM_NAME_LEN)))
  IOCTL(ASHMEM_GET_NAME, IOC_R, MK_PTR(MK_ARRAY(TYPE_CHAR, ASHMEM_NAME_LEN)))
  IOCTL(ASHMEM_SET_SIZE, IOC_W, TYPE_ULONG)
  IOCTL(ASHMEM_GET_SIZE, 0, TYPE_NULL)
  IOCTL(ASHMEM_SET_PROT_MASK, IOC_W, TYPE_ULONG)
  IOCTL(ASHMEM_GET_PROT_MASK, 0, TYPE_NULL)
  IOCTL(ASHMEM_PIN, IOC_W, MK_PTR(MK_STRUCT(STRUCT_ashmem_pin)))
  IOCTL(ASHMEM_UNPIN, IOC_W, MK_PTR(MK_STRUCT(STRUCT_ashmem_pin)))
