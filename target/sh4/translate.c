...
void sh4_translate_init(void)
{
    ...
    static const char *const gregnames[24] = {
        "R0_BANK0", "R1_BANK0", "R2_BANK0", "R3_BANK0", "R4_BANK0", "R5_BANK0",
        "R6_BANK0", "R7_BANK0", "R8",       "R9",       "R10",      "R11",
        "R12",      "R13",      "R14",      "R15",      "R0_BANK1", "R1_BANK1",
        "R2_BANK1", "R3_BANK1", "R4_BANK1", "R5_BANK1", "R6_BANK1", "R7_BANK1"
    };
    ...
    for (i = 0; i < 24; i++) {
        cpu_gregs[i] = tcg_global_mem_new_i32(
            cpu_env, offsetof(CPUSH4State, gregs[i]), gregnames[i]);
    }
    memcpy(cpu_gregs + 24, cpu_gregs + 8, 8 * sizeof(TCGv));

    cpu_pc = tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, pc), "PC");
    cpu_sr = tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, sr), "SR");
    cpu_sr_m =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, sr_m), "SR_M");
    cpu_sr_q =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, sr_q), "SR_Q");
    cpu_sr_t =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, sr_t), "SR_T");
    cpu_ssr =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, ssr), "SSR");
    cpu_spc =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, spc), "SPC");
    cpu_gbr =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, gbr), "GBR");
    cpu_vbr =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, vbr), "VBR");
    cpu_sgr =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, sgr), "SGR");
    cpu_dbr =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, dbr), "DBR");
    cpu_mach =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, mach), "MACH");
    cpu_macl =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, macl), "MACL");
    cpu_pr = tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, pr), "PR");
    cpu_fpscr =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, fpscr), "FPSCR");
    cpu_fpul =
        tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, fpul), "FPUL");

    cpu_flags = tcg_global_mem_new_i32(cpu_env, offsetof(CPUSH4State, flags),
                                       "_flags_");
    cpu_delayed_pc = tcg_global_mem_new_i32(
        cpu_env, offsetof(CPUSH4State, delayed_pc), "_delayed_pc_");
    cpu_delayed_cond = tcg_global_mem_new_i32(
        cpu_env, offsetof(CPUSH4State, delayed_cond), "_delayed_cond_");
    cpu_lock_addr = tcg_global_mem_new_i32(
        cpu_env, offsetof(CPUSH4State, lock_addr), "_lock_addr_");
    cpu_lock_value = tcg_global_mem_new_i32(
        cpu_env, offsetof(CPUSH4State, lock_value), "_lock_value_");

    for (i = 0; i < 32; i++)
        cpu_fregs[i] = tcg_global_mem_new_i32(
            cpu_env, offsetof(CPUSH4State, fregs[i]), fregnames[i]);
}
...
#define B11_0s                                                  \
    (ctx->opcode & 0x800 ? 0xfffff000 | (ctx->opcode & 0xfff) : \
                           (ctx->opcode & 0xfff))
...
static void _decode_opc(DisasContext *ctx)
{
    ...
    case 0x9000: /* mov.w @(disp,PC),Rn */
    {
        ...
        tcg_gen_qemu_ld_i32(REG(B11_8), addr, ctx->memidx, MO_TESW | MO_ALIGN);
    }
        return;
    case 0xd000: /* mov.l @(disp,PC),Rn */
    {
        TCGv addr = tcg_constant_i32((ctx->base.pc_next + 4 + B7_0 * 4) & ~3);
        tcg_gen_qemu_ld_i32(REG(B11_8), addr, ctx->memidx, MO_TESL | MO_ALIGN);
    }
        return;
    ...
    case 0x300e: /* addc Rm,Rn */
    {
        ...
        tcg_gen_add2_i32(REG(B11_8), cpu_sr_t, REG(B11_8), t0, t1, cpu_sr_t);
    }
        return;
    ...
    case 0x000f: /* mac.l @Rm+,@Rn+ */
    {
        TCGv arg0, arg1;
        arg0 = tcg_temp_new();
        tcg_gen_qemu_ld_i32(arg0, REG(B7_4), ctx->memidx, MO_TESL | MO_ALIGN);
        arg1 = tcg_temp_new();
        tcg_gen_qemu_ld_i32(arg1, REG(B11_8), ctx->memidx, MO_TESL | MO_ALIGN);
    ...
    case 0x600a: /* negc Rm,Rn */
    {
        ...
        tcg_gen_add2_i32(REG(B11_8), cpu_sr_t, REG(B7_4), t0, cpu_sr_t, t0);
        tcg_gen_sub2_i32(REG(B11_8), cpu_sr_t, t0, t0, REG(B11_8), cpu_sr_t);
    ...
    case 0x300a: /* subc Rm,Rn */
    {
        ...
        t1 = tcg_temp_new();
        tcg_gen_add2_i32(t1, cpu_sr_t, cpu_sr_t, t0, REG(B7_4), t0);
        tcg_gen_sub2_i32(REG(B11_8), cpu_sr_t, REG(B11_8), t0, t1, cpu_sr_t);
        tcg_gen_andi_i32(cpu_sr_t, cpu_sr_t, 1);
    }
        return;
    ...
    case 0xf008: /* fmov @Rm,{F,D,X}Rn - FPSCR: Nothing */
        ...
        if (ctx->tbflags & FPSCR_SZ) {
            TCGv_i64 fp = tcg_temp_new_i64();
            tcg_gen_qemu_ld_i64(fp, REG(B7_4), ctx->memidx, MO_TEUQ | MO_ALIGN);
    ...
    case 0xf00b: /* fmov {F,D,X}Rm,@-Rn - FPSCR: Nothing */
        CHECK_FPU_ENABLED
        {
            ...
            if (ctx->tbflags & FPSCR_SZ) {
                ...
                tcg_gen_qemu_st_i64(fp, addr, ctx->memidx, MO_TEUQ | MO_ALIGN);
            } else {
                tcg_gen_subi_i32(addr, REG(B11_8), 4);
    ...
    case 0xf006: /* fmov @(R0,Rm),{F,D,X}Rm - FPSCR: Nothing */
        CHECK_FPU_ENABLED
        {
            ...
            if (ctx->tbflags & FPSCR_SZ) {
                TCGv_i64 fp = tcg_temp_new_i64();
                tcg_gen_qemu_ld_i64(fp, addr, ctx->memidx, MO_TEUQ | MO_ALIGN);
                gen_store_fpr64(ctx, fp, XHACK(B11_8));
            } else {
    ...
    case 0xf005: /* fcmp/gt Rm,Rn - FPSCR: R[PR,Enable.V]/W[Cause,Flag] */
    {
        ...
        if (ctx->tbflags & FPSCR_PR) {
            ...
            switch (ctx->opcode & 0xf00f) {
            case 0xf000: /* fadd Rm,Rn */
                gen_helper_fadd_FT(FREG(B11_8), cpu_env, FREG(B11_8),
                                   FREG(B7_4));
                break;
            case 0xf001: /* fsub Rm,Rn */
                gen_helper_fsub_FT(FREG(B11_8), cpu_env, FREG(B11_8),
                                   FREG(B7_4));
                break;
            case 0xf002: /* fmul Rm,Rn */
                gen_helper_fmul_FT(FREG(B11_8), cpu_env, FREG(B11_8),
                                   FREG(B7_4));
                break;
            case 0xf003: /* fdiv Rm,Rn */
                gen_helper_fdiv_FT(FREG(B11_8), cpu_env, FREG(B11_8),
                                   FREG(B7_4));
                break;
            case 0xf004: /* fcmp/eq Rm,Rn */
                gen_helper_fcmp_eq_FT(cpu_sr_t, cpu_env, FREG(B11_8),
                                      FREG(B7_4));
                return;
            case 0xf005: /* fcmp/gt Rm,Rn */
                gen_helper_fcmp_gt_FT(cpu_sr_t, cpu_env, FREG(B11_8),
                                      FREG(B7_4));
                return;
            }
        }
    ...
    case 0xf00e: /* fmac FR0,RM,Rn */
        CHECK_FPU_ENABLED
        CHECK_FPSCR_PR_0
        gen_helper_fmac_FT(FREG(B11_8), cpu_env, FREG(0), FREG(B7_4),
                           FREG(B11_8));
        return;
    }
    ...
    case 0x8100: /* mov.w R0,@(disp,Rn) */
    {
        ...
        tcg_gen_qemu_st_i32(REG(0), addr, ctx->memidx, MO_TEUW | UNALIGN(ctx));
    }
        return;
    ...
    case 0x8500: /* mov.w @(disp,Rn),R0 */
    {
        TCGv addr = tcg_temp_new();
        tcg_gen_addi_i32(addr, REG(B7_4), B3_0 * 2);
        tcg_gen_qemu_ld_i32(REG(0), addr, ctx->memidx, MO_TESW | UNALIGN(ctx));
    }
        return;
    case 0xc700: /* mova @(disp,PC),R0 */
        tcg_gen_movi_i32(
            REG(0), ((ctx->base.pc_next & 0xfffffffc) + 4 + B7_0 * 4) & ~3);
        return;
...
#define LD(reg, ldnum, ldpnum, prechk)                                 \
    case ldnum:                                                        \
        prechk tcg_gen_mov_i32(cpu_##reg, REG(B11_8));                 \
        return;                                                        \
    case ldpnum:                                                       \
        prechk tcg_gen_qemu_ld_i32(cpu_##reg, REG(B11_8), ctx->memidx, \
                                   MO_TESL | MO_ALIGN);                \
        tcg_gen_addi_i32(REG(B11_8), REG(B11_8), 4);                   \
        return;
#define ST(reg, stnum, stpnum, prechk)                        \
    case stnum:                                               \
        prechk tcg_gen_mov_i32(REG(B11_8), cpu_##reg);        \
        return;                                               \
    case stpnum:                                              \
        prechk                                                \
        {                                                     \
...
#define LDST(reg, ldnum, ldpnum, stnum, stpnum, prechk) \
    ...
    {
        TCGv val = tcg_temp_new();
        tcg_gen_qemu_ld_i32(val, REG(B11_8), ctx->memidx, MO_TEUL | MO_ALIGN);
    ...
    case 0x0073:
        ...
        CHECK_SH4A
        {
            ...
            if ((tb_cflags(ctx->base.tb) & CF_PARALLEL)) {
                ...
                tcg_gen_brcond_i32(TCG_COND_NE, REG(B11_8), cpu_lock_addr,
                                   fail);
                tmp = tcg_temp_new();
...
#undef NEXT_INSN
    ...
    case INDEX_op_add_i32:
        ...
        if (op_dst == ld_dst && st_mop == MO_UL) {
            tcg_gen_atomic_add_fetch_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                         ctx->memidx, ld_mop);
        } else {
            tcg_gen_atomic_fetch_add_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                         ctx->memidx, ld_mop);
            if (op_dst != ld_dst) {
    ...
    case INDEX_op_and_i32:
        ...
        if (op_dst == ld_dst) {
            tcg_gen_atomic_and_fetch_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                         ctx->memidx, ld_mop);
        } else {
            tcg_gen_atomic_fetch_and_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                         ctx->memidx, ld_mop);
    ...
    case INDEX_op_or_i32:
        ...
        if (op_dst == ld_dst) {
            tcg_gen_atomic_or_fetch_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                        ctx->memidx, ld_mop);
        } else {
            tcg_gen_atomic_fetch_or_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                        ctx->memidx, ld_mop);
    ...
    case INDEX_op_xor_i32:
        ...
        if (op_dst == ld_dst) {
            tcg_gen_atomic_xor_fetch_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                         ctx->memidx, ld_mop);
        } else {
            tcg_gen_atomic_fetch_xor_i32(REG(ld_dst), REG(ld_adr), op_arg,
                                         ctx->memidx, ld_mop);
...
static void sh4_tr_init_disas_context(DisasContextBase *dcbase, CPUState *cs)
{
    ...
    ctx->gbank = ((tbflags & (1 << SR_MD)) && (tbflags & (1 << SR_RB))) * 0x10;
