...
#define TB_FLAG_DELAY_SLOT_MASK \
    (TB_FLAG_DELAY_SLOT | TB_FLAG_DELAY_SLOT_COND | TB_FLAG_DELAY_SLOT_RTE)
#define TB_FLAG_GUSA_MASK \
    ((0xff << TB_FLAG_GUSA_SHIFT) | TB_FLAG_GUSA_EXCLUSIVE)
#define TB_FLAG_FPSCR_MASK \
    (TB_FLAG_FPSCR_PR | TB_FLAG_FPSCR_SZ | TB_FLAG_FPSCR_FR)
#define TB_FLAG_SR_MASK (TB_FLAG_SR_FD | TB_FLAG_SR_RB | TB_FLAG_SR_MD)
#define TB_FLAG_ENVFLAGS_MASK (TB_FLAG_DELAY_SLOT_MASK | TB_FLAG_GUSA_MASK)
...
{
    return env->sr | (env->sr_m << SR_M) | (env->sr_q << SR_Q) |
           (env->sr_t << SR_T);
}
                                        ...
                                        uint64_t *cs_base, uint32_t *flags)
{
    ...
    *flags = env->flags | (env->fpscr & TB_FLAG_FPSCR_MASK) |
