...
static const VMStateDescription vmstate_tlbset = {
    ...
    .fields =
        (VMStateField[]){ VMSTATE_UINT32(lo, TLBSet),
                          VMSTATE_UINT32(hi, TLBSet), VMSTATE_END_OF_LIST() }
};
...
static const VMStateDescription vmstate_cris_env = {
    ...
    .fields =
        (VMStateField[]){ VMSTATE_UINT32_ARRAY(regs, CPUCRISState, 16),
                          ...
                          VMSTATE_STRUCT_ARRAY(tlbsets[0][0], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_STRUCT_ARRAY(tlbsets[0][1], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_STRUCT_ARRAY(tlbsets[0][2], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_STRUCT_ARRAY(tlbsets[0][3], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_STRUCT_ARRAY(tlbsets[1][0], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_STRUCT_ARRAY(tlbsets[1][1], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_STRUCT_ARRAY(tlbsets[1][2], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_STRUCT_ARRAY(tlbsets[1][3], CPUCRISState, 16,
                                               0, vmstate_tlbset, TLBSet),
                          VMSTATE_END_OF_LIST() }
};
...
const VMStateDescription vmstate_cris_cpu = {
    ...
    .fields = (VMStateField[]){ VMSTATE_CPU(),
                                VMSTATE_STRUCT(env, CRISCPU, 1,
                                               vmstate_cris_env, CPUCRISState),
                                VMSTATE_END_OF_LIST() }
};
