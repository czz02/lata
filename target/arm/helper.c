                        ...
                        uint64_t value)
{
    ...
    if (!arm_feature(env, ARM_FEATURE_V8)) {
        ...
        if (cpu_isar_feature(aa32_vfp_simd, env_archcpu(env))) {
            ...
            mask |= R_CPACR_ASEDIS_MASK | R_CPACR_D32DIS_MASK |
                    R_CPACR_CP11_MASK | R_CPACR_CP10_MASK;
                            ...
                            uint64_t value, const uint8_t counter)
{
    if (counter == 31) {
         ...
         */
        uint16_t old_event =
            env->cp15.c14_pmevtyper[counter] & PMXEVTYPER_EVTCOUNT;
...
static void gt_recalc_timer(ARMCPU *cpu, int timeridx)
{
    ...
    if (gt->ctl & 1) {
         ...
         */
        uint64_t offset =
            timeridx == GTIMER_VIRT ? cpu->env.cp15.cntvoff_el2 : 0;
                             ...
                             bool is_secure)
{
    ...
    ret = get_phys_addr_with_secure(env, value, access_type, mmu_idx, is_secure,
                                    &res, &fi);
                        ...
                        uint64_t value)
{
    ...
    env->cp15.par_el[1] =
        do_ats_write(env, value, access_type, mmu_idx, secure);
#else
    /* Handled by hardware accelerator. */
    g_assert_not_reached();
#endif /* CONFIG_TCG */
                                ...
                                uint64_t value)
{
    ...
    env->cp15.c0_cpuid =
        (value & (1 << 5)) ? ARM_CPUID_TI915T : ARM_CPUID_TI925T;
}
                                   ...
                                   uint64_t value)
{
    ...
    tlb_flush_page_bits_by_mmuidx_all_cpus_synced(cs, pageaddr, ARMMMUIdxBit_E2,
                                                  bits);
}
                                     ...
                                     uint64_t value)
{
    ...
    ARMVAParameters param =
        aa64_va_parameters(env, select, mmuidx, true, false);
    TLBIRange ret = {};
    ARMGranuleSize gran;
                          ...
                          bool synced)
{
    ...
    if (synced) {
        ...
        tlb_flush_range_by_mmuidx(env_cpu(env), range.base, range.length,
                                  idxmap, bits);
    }
}
                        ...
                        uint64_t value)
{
    ...
    if (ri->state == ARM_CP_STATE_AA64 && !cpu_isar_feature(aa64_mte, cpu)) {
        if (ri->opc1 == 6) { /* SCTLR_EL3 */
            ...
            value &= ~(SCTLR_ITFSB | SCTLR_TCF0 | SCTLR_TCF | SCTLR_ATA0 |
                       SCTLR_ATA);
        }
    }
...
uint64_t arm_hcr_el2_eff_secstate(CPUARMState *env, bool secure)
{
    ...
    if (ret & HCR_TGE) {
        /* These bits are up-to-date as of ARMv8.6.  */
        if (ret & HCR_E2H) {
            ret &= ~(HCR_VM | HCR_FMO | HCR_IMO | HCR_AMO | HCR_BSU_MASK |
                     HCR_DC | HCR_TWI | HCR_TWE | HCR_TID0 | HCR_TID2 |
                     HCR_TPCP | HCR_TPU | HCR_TDZ | HCR_CD | HCR_ID |
                     HCR_MIOCNCE | HCR_TID4 | HCR_TICAB | HCR_TOCU |
                     HCR_ENSCXT | HCR_TTLBIS | HCR_TTLBOS | HCR_TID5);
        } else {
...
uint64_t arm_hcrx_el2_eff(CPUARMState *env)
{
     ...
     *   - SCR_EL3.HXEn is 0.
     */
    if (!arm_is_el2_enabled(env) || (arm_feature(env, ARM_FEATURE_EL3) &&
                                     !(env->cp15.scr_el3 & SCR_HXEN))) {
        return 0;
    }
...
void register_cp_regs_for_features(ARMCPU *cpu)
{
    ...
    if (arm_feature(env, ARM_FEATURE_V8)) {
        ...
        ARMCPRegInfo v8_idregs[] = {
            ...
            { .name = "ID_AA64ISAR2_EL1_RESERVED",
              .state = ARM_CP_STATE_AA64,
              .opc0 = 3,
              .opc1 = 0,
              .crn = 0,
        ...
        static const ARMCPRegUserSpaceInfo v8_user_idregs[] = {
            ...
            { .name = "ID_AA64ZFR0_EL1",
              .exported_bits =
                  R_ID_AA64ZFR0_SVEVER_MASK | R_ID_AA64ZFR0_AES_MASK |
                  R_ID_AA64ZFR0_BITPERM_MASK | R_ID_AA64ZFR0_BFLOAT16_MASK |
                  R_ID_AA64ZFR0_SHA3_MASK | R_ID_AA64ZFR0_SM4_MASK |
                  R_ID_AA64ZFR0_I8MM_MASK | R_ID_AA64ZFR0_F32MM_MASK |
                  R_ID_AA64ZFR0_F64MM_MASK },
            { .name = "ID_AA64SMFR0_EL1",
              .exported_bits =
                  R_ID_AA64SMFR0_F32F32_MASK | R_ID_AA64SMFR0_B16F32_MASK |
                  R_ID_AA64SMFR0_F16F32_MASK | R_ID_AA64SMFR0_I8I32_MASK |
            ...
            { .name = "ID_AA64ISAR0_EL1",
              .exported_bits =
                  R_ID_AA64ISAR0_AES_MASK | R_ID_AA64ISAR0_SHA1_MASK |
            ...
            { .name = "ID_AA64ISAR1_EL1",
              .exported_bits =
                  R_ID_AA64ISAR1_DPB_MASK | R_ID_AA64ISAR1_APA_MASK |
            ...
            { .name = "ID_AA64ISAR2_EL1",
              .exported_bits =
                  R_ID_AA64ISAR2_WFXT_MASK | R_ID_AA64ISAR2_RPRES_MASK |
     ...
     */
    {
        ...
        static const ARMCPRegUserSpaceInfo id_v8_user_midr_cp_reginfo[] = {
            { .name = "MIDR_EL1",
              .exported_bits =
                  R_MIDR_EL1_REVISION_MASK | R_MIDR_EL1_PARTNUM_MASK |
                  R_MIDR_EL1_ARCHITECTURE_MASK | R_MIDR_EL1_VARIANT_MASK |
    ...
    *r2 = *r;
    ...
    if (make_const) {
        ...
        if (state == ARM_CP_STATE_AA32) {
            ...
            if (HOST_BIG_ENDIAN && r->state == ARM_CP_STATE_BOTH &&
                r2->fieldoffset) {
    ...
    for (crm = crmmin; crm <= crmmax; crm++) {
        for (opc1 = opc1min; opc1 <= opc1max; opc1++) {
            for (opc2 = opc2min; opc2 <= opc2max; opc2++) {
                for (state = ARM_CP_STATE_AA32; state <= ARM_CP_STATE_AA64;
                     state++) {
                    ...
                    if (state == ARM_CP_STATE_AA32) {
                        ...
                        case ARM_CP_SECSTATE_BOTH:
                            ...
                            add_cpreg_to_hashtable(cpu, r, opaque, state,
                                                   ARM_CP_SECSTATE_S, crm, opc1,
                                                   opc2, name);
                            g_free(name);
                            add_cpreg_to_hashtable(cpu, r, opaque, state,
                                                   ARM_CP_SECSTATE_NS, crm,
                                                   opc1, opc2, r->name);
                            break;
                        default:
                            g_assert_not_reached();
    ...
    case EXCP_SMC:
        ...
        case EC_CP14DTTRAP:
            ...
            env->exception.syndrome =
                deposit32(env->exception.syndrome, 5, 5, rt);
            break;
        case EC_CP15RRTTRAP:
        case EC_CP14RRTTRAP:
            ...
            rt = aarch64_regnum(env, rt);
            env->exception.syndrome =
                deposit32(env->exception.syndrome, 10, 5, rt);
            break;
        }
