...
#define NEON_VOP_ENV(name, vtype, n)                                     \
    uint32_t HELPER(glue(neon_, name))(CPUARMState * env, uint32_t arg1, \
                                       uint32_t arg2) NEON_VOP_BODY(vtype, n)
...
uint32_t HELPER(neon_rbit_u8)(uint32_t x)
{
    ...
    x = ((x & 0x88888888) >> 3) | ((x & 0x44444444) >> 1) |
...
{
    return ((x >> 8) & 0xff) | ((x >> 16) & 0xff00) | ((x >> 24) & 0xff0000) |
           ((x >> 32) & 0xff000000);
}
...
uint64_t HELPER(neon_paddl_u16)(uint64_t a, uint64_t b)
{
    ...
    return (tmp & 0xffff) | ((tmp >> 16) & 0xffff0000ull) |
           ((tmp2 << 16) & 0xffff00000000ull) | (tmp2 & 0xffff000000000000ull);
}
...
uint64_t HELPER(neon_addl_saturate_s32)(CPUARMState *env, uint64_t a,
                                        uint64_t b)
{
    uint32_t x, y;
    uint32_t low, high;
...
uint64_t HELPER(neon_addl_saturate_s64)(CPUARMState *env, uint64_t a,
                                        uint64_t b)
{
    uint64_t result;
