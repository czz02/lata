...
typedef void GVecGen2sFn(unsigned, uint32_t, uint32_t, TCGv_i64, uint32_t,
                         uint32_t);

typedef void gen_helper_gvec_flags_3(TCGv_i32, TCGv_ptr, TCGv_ptr, TCGv_ptr,
                                     TCGv_i32);
typedef void gen_helper_gvec_flags_4(TCGv_i32, TCGv_ptr, TCGv_ptr, TCGv_ptr,
                                     TCGv_ptr, TCGv_i32);

typedef void gen_helper_gvec_mem(TCGv_env, TCGv_ptr, TCGv_i64, TCGv_i32);
typedef void gen_helper_gvec_mem_scatter(TCGv_env, TCGv_ptr, TCGv_ptr, TCGv_ptr,
                                         TCGv_i64, TCGv_i32);
...
static bool gen_gvec_ool_zz(DisasContext *s, gen_helper_gvec_2 *fn, int rd,
                            int rn, int data)
{
    if (fn == NULL) {
        return false;
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_2_ool(vec_full_reg_offset(s, rd),
                           vec_full_reg_offset(s, rn), vsz, vsz, data, fn);
    }
    return true;
}

static bool gen_gvec_fpst_zz(DisasContext *s, gen_helper_gvec_2_ptr *fn, int rd,
                             int rn, int data, ARMFPStatusFlavour flavour)
{
    if (fn == NULL) {
        return false;
    }
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_2_ptr(vec_full_reg_offset(s, rd),
                           vec_full_reg_offset(s, rn), status, vsz, vsz, data,
                           fn);
    }
    return true;
}
...
static bool gen_gvec_ool_zzz(DisasContext *s, gen_helper_gvec_3 *fn, int rd,
                             int rn, int rm, int data)
{
    if (fn == NULL) {
        return false;
    }
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ool(vec_full_reg_offset(s, rd),
                           ...
                           vec_full_reg_offset(s, rm), vsz, vsz, data, fn);
    }
    return true;
}
                              ...
                              ARMFPStatusFlavour flavour)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ptr(
            vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn),
            vec_full_reg_offset(s, rm), status, vsz, vsz, data, fn);
    }
    return true;
}
...
static bool gen_gvec_ool_zzzz(DisasContext *s, gen_helper_gvec_4 *fn, int rd,
                              int rn, int rm, int ra, int data)
{
    if (fn == NULL) {
        return false;
    }
...
static bool gen_gvec_ool_zzp(DisasContext *s, gen_helper_gvec_3 *fn, int rd,
                             int rn, int pg, int data)
{
    if (fn == NULL) {
        return false;
    }
...
static bool gen_gvec_ool_zzzp(DisasContext *s, gen_helper_gvec_4 *fn, int rd,
                              int rn, int rm, int pg, int data)
{
    if (fn == NULL) {
        return false;
    }
                               ...
                               ARMFPStatusFlavour flavour)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_4_ptr(
            vec_full_reg_offset(s, rd), vec_full_reg_offset(s, rn),
            vec_full_reg_offset(s, rm), pred_full_reg_offset(s, pg), status,
            vsz, vsz, data, fn);
    }
    return true;
}
...
static bool gen_gvec_fn_zzi(DisasContext *s, GVecGen2iFn *gvec_fn, int esz,
                            int rd, int rn, uint64_t imm)
{
    if (gvec_fn == NULL) {
        return false;
    }
...
static bool gen_gvec_fn_zzz(DisasContext *s, GVecGen3Fn *gvec_fn, int esz,
                                 ...
                                 arg_rrrr_esz *a)
{
    ...
    if (sve_access_check(s)) {
        ...
        gvec_fn(a->esz, vec_full_reg_offset(s, a->rd),
                vec_full_reg_offset(s, a->rn), vec_full_reg_offset(s, a->rm),
...
static bool gen_gvec_fn_ppp(DisasContext *s, GVecGen3Fn *gvec_fn, int rd,
                            int rn, int rm)
{
    if (sve_access_check(s)) {
        unsigned psz = pred_gvec_reg_size(s);
        gvec_fn(MO_64, pred_full_reg_offset(s, rd), pred_full_reg_offset(s, rn),
...
static void gen_xar_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                        int64_t sh)
{
                  ...
                  uint32_t max_sz)
{
    ...
    static const GVecGen3i ops[4] = { { .fni8 = gen_xar8_i64,
                                        .fniv = gen_xar_vec,
    ...
    if (shift == 0) {
        ...
        tcg_gen_gvec_3i(rd_ofs, rn_ofs, rm_ofs, opr_sz, max_sz, shift,
                        &ops[vece]);
    }
}
...
static void gen_eor3_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                         TCGv_vec k)
{
    tcg_gen_xor_vec(vece, d, n, m);
...
static void gen_bcax_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                         TCGv_vec k)
{
...
static void gen_bsl1n_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                          TCGv_vec k)
{
...
static void gen_bsl2n_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                          TCGv_vec k)
{
    if (TCG_TARGET_HAS_bitsel_vec) {
...
static void gen_nbsl_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                         TCGv_vec k)
{
    tcg_gen_bitsel_vec(vece, d, k, n, m);
...
{
    static gen_helper_gvec_4 *const fns[4] = { gen_helper_sve_sel_zpzz_b,
...
static gen_helper_gvec_4 *const sdiv_fns[4] = { NULL, NULL,
...
static gen_helper_gvec_4 *const udiv_fns[4] = { NULL, NULL,
...
static gen_helper_gvec_reduc *const saddv_fns[4] = {
    gen_helper_sve_saddv_b, gen_helper_sve_saddv_h, gen_helper_sve_saddv_s, NULL
};
 ...
 */
static bool do_movz_zpz(DisasContext *s, int rd, int rn, int pg, int esz,
                        bool invert)
{
...
static bool do_shift_imm(DisasContext *s, arg_rri_esz *a, bool asr,
                         void (*gvec_fn)(unsigned, uint32_t, uint32_t, int64_t,
                                         uint32_t, uint32_t))
{
    if (a->esz < 0) {
        /* Invalid tsz encoding -- see tszimm_esz. */
...
#define DO_ZZW(NAME, name)                                                   \
    ...
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_ool_arg_zzz, name##_zzw_fns[a->esz], \
               a, 0)
                         ...
                         gen_helper_gvec_5 *fn)
{
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_5_ool(
            vec_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->ra),
            vec_full_reg_offset(s, a->rn), vec_full_reg_offset(s, a->rm),
            pred_full_reg_offset(s, a->pg), vsz, vsz, 0, fn);
    }
    return true;
}
...
static bool do_index(DisasContext *s, int esz, int rd, TCGv_i64 start,
                     TCGv_i64 incr)
{
    unsigned vsz;
    TCGv_i32 desc;
...
TRANS_FEAT(INDEX_ri, aa64_sve, do_index, a->esz, a->rd, cpu_reg(s, a->rn),
           tcg_constant_i64(a->imm))
TRANS_FEAT(INDEX_rr, aa64_sve, do_index, a->esz, a->rd, cpu_reg(s, a->rn),
           cpu_reg(s, a->rm))
...
TRANS_FEAT_NONSTREAMING(FEXPA, aa64_sve, gen_gvec_ool_zz, fexpa_fns[a->esz],
                        a->rd, a->rn, 0)
...
static void gen_and_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm,
                           TCGv_vec pg)
{
...
static void gen_bic_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm,
                           TCGv_vec pg)
{
...
static void gen_eor_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm,
                           TCGv_vec pg)
{
...
static void gen_orr_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm,
                           TCGv_vec pg)
{
...
static void gen_orn_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm,
                           TCGv_vec pg)
{
...
static void gen_nor_pg_vec(unsigned vece, TCGv_vec pd, TCGv_vec pn, TCGv_vec pm,
                           TCGv_vec pg)
{
    tcg_gen_or_vec(vece, pd, pn, pm);
...
TRANS_FEAT_NONSTREAMING(SETFFR, aa64_sve, do_predset, 0, FFR_PRED_NUM, 31,
                        false)
    ...
    if (inc != 0) {
        if (sve_access_check(s)) {
            tcg_gen_gvec_adds(a->esz, vec_full_reg_offset(s, a->rd),
                              vec_full_reg_offset(s, a->rn),
                              tcg_constant_i64(a->d ? -inc : inc), fullsz,
                              fullsz);
        }
    } else {
...
static bool trans_SINCDEC_v(DisasContext *s, arg_incdec2_cnt *a)
{
    ...
    if (inc != 0) {
        if (sve_access_check(s)) {
            do_sat_addsub_vec(s, a->esz, a->rd, a->rn, tcg_constant_i64(inc),
                              a->u, a->d);
        }
    } else {
        do_mov_z(s, a->rd, a->rn);
...
static bool trans_CPY_z_i(DisasContext *s, arg_CPY_z_i *a)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_2i_ool(vec_full_reg_offset(s, a->rd),
                            pred_full_reg_offset(s, a->pg),
                            tcg_constant_i64(a->imm), vsz, vsz, 0, fns[a->esz]);
    }
    return true;
}
...
static bool do_EXT(DisasContext *s, int rd, int rn, int rm, int imm)
{
     ...
     */
    if (m != d && n_ofs == size_for_gvec(n_ofs) &&
        n_siz == size_for_gvec(n_siz) && (d != n || n_siz <= n_ofs)) {
...
static bool trans_DUP_s(DisasContext *s, arg_DUP_s *a)
{
    ...
    if (sve_access_check(s)) {
        unsigned vsz = vec_full_reg_size(s);
        tcg_gen_gvec_dup_i64(a->esz, vec_full_reg_offset(s, a->rd), vsz, vsz,
                             cpu_reg_sp(s, a->rn));
    }
    return true;
}
...
static gen_helper_gvec_2 *const rev_fns[4] = { gen_helper_sve_rev_b,
                                               gen_helper_sve_rev_h,
                                               gen_helper_sve_rev_s,
                                               gen_helper_sve_rev_d };
TRANS_FEAT(REV_v, aa64_sve, gen_gvec_ool_zz, rev_fns[a->esz], a->rd, a->rn, 0)

static gen_helper_gvec_3 *const sve_tbl_fns[4] = { gen_helper_sve_tbl_b,
                                                   gen_helper_sve_tbl_h,
                                                   gen_helper_sve_tbl_s,
                                                   gen_helper_sve_tbl_d };
TRANS_FEAT(TBL, aa64_sve, gen_gvec_ool_arg_zzz, sve_tbl_fns[a->esz], a, 0)

static gen_helper_gvec_4 *const sve2_tbl_fns[4] = { gen_helper_sve2_tbl_b,
                                                    gen_helper_sve2_tbl_h,
                                                    gen_helper_sve2_tbl_s,
                                                    gen_helper_sve2_tbl_d };
TRANS_FEAT(TBL_sve2, aa64_sve2, gen_gvec_ool_zzzz, sve2_tbl_fns[a->esz], a->rd,
           a->rn, (a->rn + 1) % 32, a->rm, 0)

static gen_helper_gvec_3 *const tbx_fns[4] = { gen_helper_sve2_tbx_b,
                                               gen_helper_sve2_tbx_h,
                                               gen_helper_sve2_tbx_s,
...
TRANS_FEAT(ZIP2_z, aa64_sve, gen_gvec_ool_arg_zzz, zip_fns[a->esz], a,
           vec_full_reg_size(s) / 2)

TRANS_FEAT(ZIP1_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_zip_q,
           a, 0)
TRANS_FEAT(ZIP2_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_zip_q,
           a, QEMU_ALIGN_DOWN(vec_full_reg_size(s), 32) / 2)
...
TRANS_FEAT(UZP2_z, aa64_sve, gen_gvec_ool_arg_zzz, uzp_fns[a->esz], a,
           1 << a->esz)

TRANS_FEAT(UZP1_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_uzp_q,
           a, 0)
TRANS_FEAT(UZP2_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_uzp_q,
           a, 16)
...
TRANS_FEAT(TRN2_z, aa64_sve, gen_gvec_ool_arg_zzz, trn_fns[a->esz], a,
           1 << a->esz)

TRANS_FEAT(TRN1_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_trn_q,
           a, 0)
TRANS_FEAT(TRN2_q, aa64_sve_f64mm, gen_gvec_ool_arg_zzz, gen_helper_sve2_trn_q,
           a, 16)
...
static gen_helper_gvec_3 *const compact_fns[4] = { NULL, NULL,
...
static TCGv_i64 load_last_active(DisasContext *s, TCGv_i32 last, int rm,
                                 int esz)
{
                            ...
                            bool before, TCGv_i64 reg_val)
{
    ...
    tcg_gen_movcond_i64(TCG_COND_GE, reg_val, cmp, tcg_constant_i64(0), ele,
                        reg_val);
}
...
static TCGv_i64 do_last_scalar(DisasContext *s, int esz, int pg, int rm,
                               bool before)
{
    TCGv_i32 last = tcg_temp_new_i32();
...
TRANS_FEAT(SPLICE, aa64_sve, gen_gvec_ool_arg_zpzz, gen_helper_sve_splice, a,
           a->esz)
...
static bool do_brk3(DisasContext *s, arg_rprr_s *a, gen_helper_gvec_4 *fn,
                    gen_helper_gvec_flags_4 *fn_s)
{
    if (!sve_access_check(s)) {
        return true;
    }
...
static bool do_brk2(DisasContext *s, arg_rpr_s *a, gen_helper_gvec_3 *fn,
                    gen_helper_gvec_flags_3 *fn_s)
{
    if (!sve_access_check(s)) {
        return true;
    }
...
TRANS_FEAT(BRKPA, aa64_sve, do_brk3, a, gen_helper_sve_brkpa,
           gen_helper_sve_brkpas)
TRANS_FEAT(BRKPB, aa64_sve, do_brk3, a, gen_helper_sve_brkpb,
           gen_helper_sve_brkpbs)

TRANS_FEAT(BRKA_m, aa64_sve, do_brk2, a, gen_helper_sve_brka_m,
           gen_helper_sve_brkas_m)
TRANS_FEAT(BRKB_m, aa64_sve, do_brk2, a, gen_helper_sve_brkb_m,
           gen_helper_sve_brkbs_m)

TRANS_FEAT(BRKA_z, aa64_sve, do_brk2, a, gen_helper_sve_brka_z,
           gen_helper_sve_brkas_z)
TRANS_FEAT(BRKB_z, aa64_sve, do_brk2, a, gen_helper_sve_brkb_z,
           gen_helper_sve_brkbs_z)

TRANS_FEAT(BRKN, aa64_sve, do_brk2, a, gen_helper_sve_brkn,
...
static bool trans_WHILE(DisasContext *s, arg_WHILE *a)
{
    ...
    if (a->lt ? !dc_isar_feature(aa64_sve, s) :
...
{
    if (sve_access_check(s)) {
        do_sat_addsub_vec(s, a->esz, a->rd, a->rn, tcg_constant_i64(a->imm), u,
                          d);
    }
    return true;
}
...
TRANS_FEAT(DOT_zzzz, aa64_sve, gen_gvec_ool_zzzz, dot_fns[a->u][a->sz], a->rd,
           a->rn, a->rm, a->ra, 0)
...
#define DO_SVE2_RRX(NAME, FUNC)                                             \
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_ool_zzz, FUNC, a->rd, a->rn, a->rm, \
               a->index)
...
#define DO_SVE2_RRXR_TB(NAME, FUNC, TOP)                                      \
    TRANS_FEAT(NAME, aa64_sve2, gen_gvec_ool_zzzz, FUNC, a->rd, a->rn, a->rm, \
               a->ra, (a->index << 1) | TOP)
...
TRANS_FEAT(FMUL_zzx, aa64_sve, gen_gvec_fpst_zzz, fmul_idx_fns[a->esz], a->rd,
           a->rn, a->rm, a->index, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

/*
 *** SVE Floating Point Fast Reduction Group
 */

typedef void gen_helper_fp_reduce(TCGv_i64, TCGv_ptr, TCGv_ptr, TCGv_ptr,
                                  TCGv_i32);
                      ...
                      gen_helper_gvec_3_ptr *fn)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_3_ptr(
            pred_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn),
...
TRANS_FEAT_NONSTREAMING(FTMAD, aa64_sve, gen_gvec_fpst_zzz, ftmad_fns[a->esz],
                        a->rd, a->rn, a->rm, a->imm,
                        a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
{
    typedef void fadda_fn(TCGv_i64, TCGv_i64, TCGv_ptr, TCGv_ptr, TCGv_ptr,
                          TCGv_i32);
...
#define DO_FP3(NAME, name)                                            \
    static gen_helper_gvec_3_ptr *const name##_fns[4] = {             \
        NULL, gen_helper_gvec_##name##_h, gen_helper_gvec_##name##_s, \
...
static gen_helper_gvec_3_ptr *const ftsmul_fns[4] = {
    NULL, gen_helper_gvec_ftsmul_h, gen_helper_gvec_ftsmul_s,
...
#define DO_ZPZZ_FP(NAME, FEAT, name)                           \
    static gen_helper_gvec_4_ptr *const name##_zpzz_fns[4] = { \
        NULL, gen_helper_##name##_h, gen_helper_##name##_s,    \
        gen_helper_##name##_d                                  \
    };                                                         \
...
typedef void gen_helper_sve_fp2scalar(TCGv_ptr, TCGv_ptr, TCGv_ptr, TCGv_i64,
                                      TCGv_ptr, TCGv_i32);
...
#define DO_FP_IMM(NAME, name, const0, const1)                       \
    static gen_helper_sve_fp2scalar *const name##_fns[4] = {        \
        NULL, gen_helper_sve_##name##_h, gen_helper_sve_##name##_s, \
        gen_helper_sve_##name##_d                                   \
    };                                                              \
                      ...
                      gen_helper_gvec_4_ptr *fn)
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_4_ptr(
            pred_full_reg_offset(s, a->rd), vec_full_reg_offset(s, a->rn),
            vec_full_reg_offset(s, a->rm), pred_full_reg_offset(s, a->pg),
            status, vsz, vsz, 0, fn);
    }
    return true;
}
...
TRANS_FEAT(FCADD, aa64_sve, gen_gvec_fpst_zzzp, fcadd_fns[a->esz], a->rd, a->rn,
           a->rm, a->pg, a->rot, a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
#define DO_FMLA(NAME, name)                                                    \
    ...
    TRANS_FEAT(NAME, aa64_sve, gen_gvec_fpst_zzzzp, name##_fns[a->esz], a->rd, \
               a->rn, a->rm, a->ra, a->pg, 0,                                  \
               a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
TRANS_FEAT(FCMLA_zpzzz, aa64_sve, gen_gvec_fpst_zzzzp, fcmla_fns[a->esz], a->rd,
           a->rn, a->rm, a->ra, a->pg, a->rot,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
TRANS_FEAT(FCVT_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_sh, a,
           0, FPST_FPCR)
TRANS_FEAT(FCVT_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_hs, a,
           0, FPST_FPCR)

TRANS_FEAT(BFCVT, aa64_sve_bf16, gen_gvec_fpst_arg_zpz, gen_helper_sve_bfcvt, a,
           0, FPST_FPCR)

TRANS_FEAT(FCVT_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_dh, a,
           0, FPST_FPCR)
TRANS_FEAT(FCVT_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_hd, a,
           0, FPST_FPCR)
TRANS_FEAT(FCVT_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_ds, a,
           0, FPST_FPCR)
TRANS_FEAT(FCVT_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvt_sd, a,
           0, FPST_FPCR)

TRANS_FEAT(FCVTZS_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hh,
           a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZU_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hh,
           a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZS_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hs,
           a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZU_hs, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hs,
           a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZS_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_hd,
           a, 0, FPST_FPCR_F16)
TRANS_FEAT(FCVTZU_hd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_hd,
           a, 0, FPST_FPCR_F16)

TRANS_FEAT(FCVTZS_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_ss,
           a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_ss,
           a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZS_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_sd,
           a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_sd,
           a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZS_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_ds,
           a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_ds,
           a, 0, FPST_FPCR)

TRANS_FEAT(FCVTZS_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzs_dd,
           a, 0, FPST_FPCR)
TRANS_FEAT(FCVTZU_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_fcvtzu_dd,
           a, 0, FPST_FPCR)

static gen_helper_gvec_3_ptr *const frint_fns[] = {
    NULL, gen_helper_sve_frint_h, gen_helper_sve_frint_s, gen_helper_sve_frint_d
};
TRANS_FEAT(FRINTI, aa64_sve, gen_gvec_fpst_arg_zpz, frint_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

static gen_helper_gvec_3_ptr *const frintx_fns[] = { NULL,
...
static bool do_frint_mode(DisasContext *s, arg_rpr_esz *a, ARMFPRounding mode,
                          gen_helper_gvec_3_ptr *fn)
{
    unsigned vsz;
    TCGv_i32 tmode;
...
TRANS_FEAT(FRINTN, aa64_sve, do_frint_mode, a, FPROUNDING_TIEEVEN,
           frint_fns[a->esz])
TRANS_FEAT(FRINTP, aa64_sve, do_frint_mode, a, FPROUNDING_POSINF,
           frint_fns[a->esz])
TRANS_FEAT(FRINTM, aa64_sve, do_frint_mode, a, FPROUNDING_NEGINF,
           frint_fns[a->esz])
TRANS_FEAT(FRINTZ, aa64_sve, do_frint_mode, a, FPROUNDING_ZERO,
           frint_fns[a->esz])
TRANS_FEAT(FRINTA, aa64_sve, do_frint_mode, a, FPROUNDING_TIEAWAY,
           frint_fns[a->esz])
...
TRANS_FEAT(FRECPX, aa64_sve, gen_gvec_fpst_arg_zpz, frecpx_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)
...
TRANS_FEAT(FSQRT, aa64_sve, gen_gvec_fpst_arg_zpz, fsqrt_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

TRANS_FEAT(SCVTF_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_hh, a,
           0, FPST_FPCR_F16)
TRANS_FEAT(SCVTF_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_sh, a,
           0, FPST_FPCR_F16)
TRANS_FEAT(SCVTF_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_dh, a,
           0, FPST_FPCR_F16)

TRANS_FEAT(SCVTF_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_ss, a,
           0, FPST_FPCR)
TRANS_FEAT(SCVTF_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_ds, a,
           0, FPST_FPCR)

TRANS_FEAT(SCVTF_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_sd, a,
           0, FPST_FPCR)
TRANS_FEAT(SCVTF_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_scvt_dd, a,
           0, FPST_FPCR)

TRANS_FEAT(UCVTF_hh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_hh, a,
           0, FPST_FPCR_F16)
TRANS_FEAT(UCVTF_sh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_sh, a,
           0, FPST_FPCR_F16)
TRANS_FEAT(UCVTF_dh, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_dh, a,
           0, FPST_FPCR_F16)

TRANS_FEAT(UCVTF_ss, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_ss, a,
           0, FPST_FPCR)
TRANS_FEAT(UCVTF_ds, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_ds, a,
           0, FPST_FPCR)
TRANS_FEAT(UCVTF_sd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_sd, a,
           0, FPST_FPCR)

TRANS_FEAT(UCVTF_dd, aa64_sve, gen_gvec_fpst_arg_zpz, gen_helper_sve_ucvt_dd, a,
           0, FPST_FPCR)
...
void gen_sve_ldr(DisasContext *s, TCGv_ptr base, int vofs, int len, int rn,
                 int imm)
{
...
void gen_sve_str(DisasContext *s, TCGv_ptr base, int vofs, int len, int rn,
                 int imm)
{
    int len_align = QEMU_ALIGN_DOWN(len, 16);
    int len_remain = len % 16;
...
static const MemOp dtype_mop[16] = { MO_UB, MO_UB, MO_UB, MO_UB, MO_SL, MO_UW,
                                     MO_UW, MO_UW, MO_SW, MO_SW, MO_UL, MO_UL,
                                     MO_SB, MO_SB, MO_SB, MO_UQ };

#define dtype_msz(x) (dtype_mop[x] & MO_SIZE)

/* The vector element size of dtype.  */
static const uint8_t dtype_esz[16] = { 0, 1, 2, 3, 3, 1, 2, 3,
                                       3, 2, 2, 3, 3, 2, 1, 3 };
...
static gen_helper_gvec_mem *const ldr_fns[2][2][16][4] = {
    ...
    { /* mte active, little-endian */
      { { gen_helper_sve_ld1bb_r_mte, gen_helper_sve_ld2bb_r_mte,
        ...
        { gen_helper_sve_ld1hh_le_r_mte, gen_helper_sve_ld2hh_le_r_mte,
          gen_helper_sve_ld3hh_le_r_mte, gen_helper_sve_ld4hh_le_r_mte },
        ...
        { gen_helper_sve_ld1ss_le_r_mte, gen_helper_sve_ld2ss_le_r_mte,
          gen_helper_sve_ld3ss_le_r_mte, gen_helper_sve_ld4ss_le_r_mte },
        ...
        { gen_helper_sve_ld1dd_le_r_mte, gen_helper_sve_ld2dd_le_r_mte,
          gen_helper_sve_ld3dd_le_r_mte, gen_helper_sve_ld4dd_le_r_mte } },
      ...
      { { gen_helper_sve_ld1bb_r_mte, gen_helper_sve_ld2bb_r_mte,
        ...
        { gen_helper_sve_ld1hh_be_r_mte, gen_helper_sve_ld2hh_be_r_mte,
          gen_helper_sve_ld3hh_be_r_mte, gen_helper_sve_ld4hh_be_r_mte },
        ...
        { gen_helper_sve_ld1ss_be_r_mte, gen_helper_sve_ld2ss_be_r_mte,
          gen_helper_sve_ld3ss_be_r_mte, gen_helper_sve_ld4ss_be_r_mte },
        { gen_helper_sve_ld1sdu_be_r_mte, NULL, NULL, NULL },

        { gen_helper_sve_ld1bds_r_mte, NULL, NULL, NULL },
        { gen_helper_sve_ld1bss_r_mte, NULL, NULL, NULL },
        { gen_helper_sve_ld1bhs_r_mte, NULL, NULL, NULL },
        { gen_helper_sve_ld1dd_be_r_mte, gen_helper_sve_ld2dd_be_r_mte,
          gen_helper_sve_ld3dd_be_r_mte, gen_helper_sve_ld4dd_be_r_mte } } },
};

static void do_ld_zpa(DisasContext *s, int zt, int pg, TCGv_i64 addr, int dtype,
                      int nreg)
{
    gen_helper_gvec_mem *fn =
...
static bool trans_LDFF1_zprr(DisasContext *s, arg_rprr_load *a)
{
    static gen_helper_gvec_mem *const fns[2][2][16] = {
        { /* mte inactive, little-endian */
          { gen_helper_sve_ldff1bb_r, gen_helper_sve_ldff1bhu_r,
            gen_helper_sve_ldff1bsu_r, gen_helper_sve_ldff1bdu_r,

            gen_helper_sve_ldff1sds_le_r, gen_helper_sve_ldff1hh_le_r,
            gen_helper_sve_ldff1hsu_le_r, gen_helper_sve_ldff1hdu_le_r,

            gen_helper_sve_ldff1hds_le_r, gen_helper_sve_ldff1hss_le_r,
            gen_helper_sve_ldff1ss_le_r, gen_helper_sve_ldff1sdu_le_r,

            gen_helper_sve_ldff1bds_r, gen_helper_sve_ldff1bss_r,
            gen_helper_sve_ldff1bhs_r, gen_helper_sve_ldff1dd_le_r },

          /* mte inactive, big-endian */
          { gen_helper_sve_ldff1bb_r, gen_helper_sve_ldff1bhu_r,
            gen_helper_sve_ldff1bsu_r, gen_helper_sve_ldff1bdu_r,

            gen_helper_sve_ldff1sds_be_r, gen_helper_sve_ldff1hh_be_r,
            gen_helper_sve_ldff1hsu_be_r, gen_helper_sve_ldff1hdu_be_r,

            gen_helper_sve_ldff1hds_be_r, gen_helper_sve_ldff1hss_be_r,
            gen_helper_sve_ldff1ss_be_r, gen_helper_sve_ldff1sdu_be_r,

            gen_helper_sve_ldff1bds_r, gen_helper_sve_ldff1bss_r,
            gen_helper_sve_ldff1bhs_r, gen_helper_sve_ldff1dd_be_r } },

        { /* mte active, little-endian */
          { gen_helper_sve_ldff1bb_r_mte, gen_helper_sve_ldff1bhu_r_mte,
            gen_helper_sve_ldff1bsu_r_mte, gen_helper_sve_ldff1bdu_r_mte,

            gen_helper_sve_ldff1sds_le_r_mte, gen_helper_sve_ldff1hh_le_r_mte,
            gen_helper_sve_ldff1hsu_le_r_mte, gen_helper_sve_ldff1hdu_le_r_mte,

            gen_helper_sve_ldff1hds_le_r_mte, gen_helper_sve_ldff1hss_le_r_mte,
            gen_helper_sve_ldff1ss_le_r_mte, gen_helper_sve_ldff1sdu_le_r_mte,

            gen_helper_sve_ldff1bds_r_mte, gen_helper_sve_ldff1bss_r_mte,
            gen_helper_sve_ldff1bhs_r_mte, gen_helper_sve_ldff1dd_le_r_mte },

          /* mte active, big-endian */
          { gen_helper_sve_ldff1bb_r_mte, gen_helper_sve_ldff1bhu_r_mte,
            gen_helper_sve_ldff1bsu_r_mte, gen_helper_sve_ldff1bdu_r_mte,

            gen_helper_sve_ldff1sds_be_r_mte, gen_helper_sve_ldff1hh_be_r_mte,
            gen_helper_sve_ldff1hsu_be_r_mte, gen_helper_sve_ldff1hdu_be_r_mte,

            gen_helper_sve_ldff1hds_be_r_mte, gen_helper_sve_ldff1hss_be_r_mte,
            gen_helper_sve_ldff1ss_be_r_mte, gen_helper_sve_ldff1sdu_be_r_mte,

            gen_helper_sve_ldff1bds_r_mte, gen_helper_sve_ldff1bss_r_mte,
            gen_helper_sve_ldff1bhs_r_mte, gen_helper_sve_ldff1dd_be_r_mte } },
    };
...
static bool trans_LDNF1_zpri(DisasContext *s, arg_rpri_load *a)
{
    static gen_helper_gvec_mem *const fns[2][2][16] = {
        { /* mte inactive, little-endian */
          { gen_helper_sve_ldnf1bb_r, gen_helper_sve_ldnf1bhu_r,
            gen_helper_sve_ldnf1bsu_r, gen_helper_sve_ldnf1bdu_r,

            gen_helper_sve_ldnf1sds_le_r, gen_helper_sve_ldnf1hh_le_r,
            gen_helper_sve_ldnf1hsu_le_r, gen_helper_sve_ldnf1hdu_le_r,

            gen_helper_sve_ldnf1hds_le_r, gen_helper_sve_ldnf1hss_le_r,
            gen_helper_sve_ldnf1ss_le_r, gen_helper_sve_ldnf1sdu_le_r,

            gen_helper_sve_ldnf1bds_r, gen_helper_sve_ldnf1bss_r,
            gen_helper_sve_ldnf1bhs_r, gen_helper_sve_ldnf1dd_le_r },

          /* mte inactive, big-endian */
          { gen_helper_sve_ldnf1bb_r, gen_helper_sve_ldnf1bhu_r,
            gen_helper_sve_ldnf1bsu_r, gen_helper_sve_ldnf1bdu_r,

            gen_helper_sve_ldnf1sds_be_r, gen_helper_sve_ldnf1hh_be_r,
            gen_helper_sve_ldnf1hsu_be_r, gen_helper_sve_ldnf1hdu_be_r,

            gen_helper_sve_ldnf1hds_be_r, gen_helper_sve_ldnf1hss_be_r,
            gen_helper_sve_ldnf1ss_be_r, gen_helper_sve_ldnf1sdu_be_r,

            gen_helper_sve_ldnf1bds_r, gen_helper_sve_ldnf1bss_r,
            gen_helper_sve_ldnf1bhs_r, gen_helper_sve_ldnf1dd_be_r } },

        { /* mte inactive, little-endian */
          { gen_helper_sve_ldnf1bb_r_mte, gen_helper_sve_ldnf1bhu_r_mte,
            gen_helper_sve_ldnf1bsu_r_mte, gen_helper_sve_ldnf1bdu_r_mte,

            gen_helper_sve_ldnf1sds_le_r_mte, gen_helper_sve_ldnf1hh_le_r_mte,
            gen_helper_sve_ldnf1hsu_le_r_mte, gen_helper_sve_ldnf1hdu_le_r_mte,

            gen_helper_sve_ldnf1hds_le_r_mte, gen_helper_sve_ldnf1hss_le_r_mte,
            gen_helper_sve_ldnf1ss_le_r_mte, gen_helper_sve_ldnf1sdu_le_r_mte,

            gen_helper_sve_ldnf1bds_r_mte, gen_helper_sve_ldnf1bss_r_mte,
            gen_helper_sve_ldnf1bhs_r_mte, gen_helper_sve_ldnf1dd_le_r_mte },

          /* mte inactive, big-endian */
          { gen_helper_sve_ldnf1bb_r_mte, gen_helper_sve_ldnf1bhu_r_mte,
            gen_helper_sve_ldnf1bsu_r_mte, gen_helper_sve_ldnf1bdu_r_mte,

            gen_helper_sve_ldnf1sds_be_r_mte, gen_helper_sve_ldnf1hh_be_r_mte,
            gen_helper_sve_ldnf1hsu_be_r_mte, gen_helper_sve_ldnf1hdu_be_r_mte,

            gen_helper_sve_ldnf1hds_be_r_mte, gen_helper_sve_ldnf1hss_be_r_mte,
            gen_helper_sve_ldnf1ss_be_r_mte, gen_helper_sve_ldnf1sdu_be_r_mte,
...
static void do_st_zpa(DisasContext *s, int zt, int pg, TCGv_i64 addr, int msz,
                      int esz, int nreg)
{
    static gen_helper_gvec_mem *const fn_single[2][2][4][4] = {
        { { { gen_helper_sve_st1bb_r, gen_helper_sve_st1bh_r,
            ...
            { NULL, gen_helper_sve_st1hh_le_r, gen_helper_sve_st1hs_le_r,
              gen_helper_sve_st1hd_le_r },
            { NULL, NULL, gen_helper_sve_st1ss_le_r,
              gen_helper_sve_st1sd_le_r },
            { NULL, NULL, NULL, gen_helper_sve_st1dd_le_r } },
          { { gen_helper_sve_st1bb_r, gen_helper_sve_st1bh_r,
              gen_helper_sve_st1bs_r, gen_helper_sve_st1bd_r },
            { NULL, gen_helper_sve_st1hh_be_r, gen_helper_sve_st1hs_be_r,
              gen_helper_sve_st1hd_be_r },
            { NULL, NULL, gen_helper_sve_st1ss_be_r,
              gen_helper_sve_st1sd_be_r },
            { NULL, NULL, NULL, gen_helper_sve_st1dd_be_r } } },

        { { { gen_helper_sve_st1bb_r_mte, gen_helper_sve_st1bh_r_mte,
              gen_helper_sve_st1bs_r_mte, gen_helper_sve_st1bd_r_mte },
            { NULL, gen_helper_sve_st1hh_le_r_mte,
              gen_helper_sve_st1hs_le_r_mte, gen_helper_sve_st1hd_le_r_mte },
            { NULL, NULL, gen_helper_sve_st1ss_le_r_mte,
              gen_helper_sve_st1sd_le_r_mte },
            { NULL, NULL, NULL, gen_helper_sve_st1dd_le_r_mte } },
          { { gen_helper_sve_st1bb_r_mte, gen_helper_sve_st1bh_r_mte,
              gen_helper_sve_st1bs_r_mte, gen_helper_sve_st1bd_r_mte },
            { NULL, gen_helper_sve_st1hh_be_r_mte,
              gen_helper_sve_st1hs_be_r_mte, gen_helper_sve_st1hd_be_r_mte },
            { NULL, NULL, gen_helper_sve_st1ss_be_r_mte,
              gen_helper_sve_st1sd_be_r_mte },
            { NULL, NULL, NULL, gen_helper_sve_st1dd_be_r_mte } } },
    };
    static gen_helper_gvec_mem *const fn_multiple[2][2][3][4] = {
        { { { gen_helper_sve_st2bb_r, gen_helper_sve_st2hh_le_r,
              gen_helper_sve_st2ss_le_r, gen_helper_sve_st2dd_le_r },
            { gen_helper_sve_st3bb_r, gen_helper_sve_st3hh_le_r,
              gen_helper_sve_st3ss_le_r, gen_helper_sve_st3dd_le_r },
            { gen_helper_sve_st4bb_r, gen_helper_sve_st4hh_le_r,
              gen_helper_sve_st4ss_le_r, gen_helper_sve_st4dd_le_r } },
          { { gen_helper_sve_st2bb_r, gen_helper_sve_st2hh_be_r,
              gen_helper_sve_st2ss_be_r, gen_helper_sve_st2dd_be_r },
            { gen_helper_sve_st3bb_r, gen_helper_sve_st3hh_be_r,
              gen_helper_sve_st3ss_be_r, gen_helper_sve_st3dd_be_r },
            { gen_helper_sve_st4bb_r, gen_helper_sve_st4hh_be_r,
              gen_helper_sve_st4ss_be_r, gen_helper_sve_st4dd_be_r } } },
        { { { gen_helper_sve_st2bb_r_mte, gen_helper_sve_st2hh_le_r_mte,
              gen_helper_sve_st2ss_le_r_mte, gen_helper_sve_st2dd_le_r_mte },
            { gen_helper_sve_st3bb_r_mte, gen_helper_sve_st3hh_le_r_mte,
              gen_helper_sve_st3ss_le_r_mte, gen_helper_sve_st3dd_le_r_mte },
            { gen_helper_sve_st4bb_r_mte, gen_helper_sve_st4hh_le_r_mte,
              gen_helper_sve_st4ss_le_r_mte, gen_helper_sve_st4dd_le_r_mte } },
          { { gen_helper_sve_st2bb_r_mte, gen_helper_sve_st2hh_be_r_mte,
              gen_helper_sve_st2ss_be_r_mte, gen_helper_sve_st2dd_be_r_mte },
            { gen_helper_sve_st3bb_r_mte, gen_helper_sve_st3hh_be_r_mte,
              gen_helper_sve_st3ss_be_r_mte, gen_helper_sve_st3dd_be_r_mte },
            { gen_helper_sve_st4bb_r_mte, gen_helper_sve_st4hh_be_r_mte,
...
static void do_mem_zpz(DisasContext *s, int zt, int pg, int zm, int scale,
                       TCGv_i64 scalar, int msz, bool is_write,
...
static bool trans_LD1_zprz(DisasContext *s, arg_LD1_zprz *a)
{
    ...
    do_mem_zpz(s, a->rd, a->pg, a->rm, a->scale * a->msz, cpu_reg_sp(s, a->rn),
               a->msz, false, fn);
    return true;
}
...
static bool trans_LD1_zpiz(DisasContext *s, arg_LD1_zpiz *a)
{
     ...
     */
    do_mem_zpz(s, a->rd, a->pg, a->rn, 0, tcg_constant_i64(a->imm << a->msz),
               a->msz, false, fn);
    return true;
}
...
TRANS_FEAT(SMULH_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, smulh_zzz_fns[a->esz], a,
           0)
...
TRANS_FEAT(UMULH_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, umulh_zzz_fns[a->esz], a,
           0)

TRANS_FEAT(PMUL_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, gen_helper_gvec_pmul_b, a,
           0)
...
TRANS_FEAT(SADALP_zpzz, aa64_sve2, gen_gvec_ool_arg_zpzz, sadlp_fns[a->esz], a,
           0)
...
TRANS_FEAT(UADALP_zpzz, aa64_sve2, gen_gvec_ool_arg_zpzz, uadlp_fns[a->esz], a,
           0)
...
TRANS_FEAT(SQDMULLB_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, sqdmull_fns[a->esz],
           a, 0)
TRANS_FEAT(SQDMULLT_zzz, aa64_sve2, gen_gvec_ool_arg_zzz, sqdmull_fns[a->esz],
           a, 3)
...
static bool do_shll_tb(DisasContext *s, arg_rri_esz *a, const GVecGen2i ops[3],
                       bool sel)
{
    if (a->esz < 0 || a->esz > 2) {
        return false;
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_2i(vec_full_reg_offset(s, a->rd),
                        vec_full_reg_offset(s, a->rn), vsz, vsz,
                        (a->imm << 1) | sel, &ops[a->esz]);
    }
    return true;
}

static const TCGOpcode sshll_list[] = { INDEX_op_shli_vec, INDEX_op_sari_vec,
                                        0 };
static const GVecGen2i sshll_ops[3] = { { .fniv = gen_sshll_vec,
                                          .opt_opc = sshll_list,
...
static const TCGOpcode ushll_list[] = { INDEX_op_shli_vec, INDEX_op_shri_vec,
                                        0 };
...
TRANS_FEAT(SQCADD_rot90, aa64_sve2, gen_gvec_ool_arg_zzz, sqcadd_fns[a->esz], a,
           0)
TRANS_FEAT(SQCADD_rot270, aa64_sve2, gen_gvec_ool_arg_zzz, sqcadd_fns[a->esz],
           a, 1)
                              ...
                              const GVecGen2 ops[3])
{
    ...
    if (sve_access_check(s)) {
        ...
        tcg_gen_gvec_2(vec_full_reg_offset(s, a->rd),
                       vec_full_reg_offset(s, a->rn), vsz, vsz, &ops[a->esz]);
    }
    return true;
}

static const TCGOpcode sqxtn_list[] = { INDEX_op_shli_vec, INDEX_op_smin_vec,
                                        INDEX_op_smax_vec, 0 };
...
static const TCGOpcode uqxtn_list[] = { INDEX_op_shli_vec, INDEX_op_umin_vec,
                                        0 };
...
static const TCGOpcode sqxtun_list[] = { INDEX_op_shli_vec, INDEX_op_umin_vec,
                                         INDEX_op_smax_vec, 0 };
...
static const TCGOpcode sqshrunb_vec_list[] = { INDEX_op_sari_vec,
                                               INDEX_op_smax_vec,
                                               INDEX_op_umin_vec, 0 };
...
static const TCGOpcode sqshrunt_vec_list[] = { INDEX_op_shli_vec,
                                               INDEX_op_sari_vec,
                                               INDEX_op_smax_vec,
                                               INDEX_op_umin_vec, 0 };
...
static const TCGOpcode sqshrnb_vec_list[] = { INDEX_op_sari_vec,
                                              INDEX_op_smax_vec,
                                              INDEX_op_smin_vec, 0 };
...
static const TCGOpcode sqshrnt_vec_list[] = { INDEX_op_shli_vec,
                                              INDEX_op_sari_vec,
                                              INDEX_op_smax_vec,
                                              INDEX_op_smin_vec, 0 };
...
static const TCGOpcode uqshrnt_vec_list[] = { INDEX_op_shli_vec,
                                              INDEX_op_shri_vec,
                                              INDEX_op_umin_vec, 0 };
...
static gen_helper_gvec_4 *const histcnt_fns[4] = { NULL, NULL,
...
TRANS_FEAT_NONSTREAMING(FMMLA_s, aa64_sve_f32mm, gen_gvec_fpst_zzzz,
                        gen_helper_fmmla_s, a->rd, a->rn, a->rm, a->ra, 0,
                        FPST_FPCR)
TRANS_FEAT_NONSTREAMING(FMMLA_d, aa64_sve_f64mm, gen_gvec_fpst_zzzz,
                        gen_helper_fmmla_d, a->rd, a->rn, a->rm, a->ra, 0,
                        FPST_FPCR)
...
TRANS_FEAT(CMLA_zzzz, aa64_sve2, gen_gvec_ool_zzzz, cmla_fns[a->esz], a->rd,
           a->rn, a->rm, a->ra, a->rot)

static gen_helper_gvec_4 *const cdot_fns[] = { NULL, NULL,
                                               gen_helper_sve2_cdot_zzzz_s,
                                               gen_helper_sve2_cdot_zzzz_d };
TRANS_FEAT(CDOT_zzzz, aa64_sve2, gen_gvec_ool_zzzz, cdot_fns[a->esz], a->rd,
           a->rn, a->rm, a->ra, a->rot)
...
TRANS_FEAT(SQRDCMLAH_zzzz, aa64_sve2, gen_gvec_ool_zzzz, sqrdcmlah_fns[a->esz],
           a->rd, a->rn, a->rm, a->ra, a->rot)
...
TRANS_FEAT(FCVTX_ds, aa64_sve2, do_frint_mode, a, FPROUNDING_ODD,
           gen_helper_sve_fcvt_ds)
TRANS_FEAT(FCVTXNT_ds, aa64_sve2, do_frint_mode, a, FPROUNDING_ODD,
           gen_helper_sve2_fcvtnt_ds)

static gen_helper_gvec_3_ptr *const flogb_fns[] = { NULL, gen_helper_flogb_h,
                                                    gen_helper_flogb_s,
                                                    gen_helper_flogb_d };
TRANS_FEAT(FLOGB, aa64_sve2, gen_gvec_fpst_arg_zpz, flogb_fns[a->esz], a, 0,
           a->esz == MO_16 ? FPST_FPCR_F16 : FPST_FPCR)

static bool do_FMLAL_zzzw(DisasContext *s, arg_rrrr_esz *a, bool sub, bool sel)
{
    return gen_gvec_ptr_zzzz(s, gen_helper_sve2_fmlal_zzzw_s, a->rd, a->rn,
                             a->rm, a->ra, (sel << 1) | sub, cpu_env);
}
...
{
    return gen_gvec_ptr_zzzz(s, gen_helper_sve2_fmlal_zzxw_s, a->rd, a->rn,
                             a->rm, a->ra, (a->index << 2) | (sel << 1) | sub,
                             cpu_env);
}
...
{
    return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlal, a->rd, a->rn, a->rm,
                              a->ra, sel, FPST_FPCR);
}
...
{
    return gen_gvec_fpst_zzzz(s, gen_helper_gvec_bfmlal_idx, a->rd, a->rn,
                              a->rm, a->ra, (a->index << 1) | sel, FPST_FPCR);
}
...
static void gen_sclamp_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                           TCGv_vec a)
{
...
static void gen_sclamp(unsigned vece, uint32_t d, uint32_t n, uint32_t m,
                       uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    static const TCGOpcode vecop[] = { INDEX_op_smin_vec, INDEX_op_smax_vec,
                                       0 };
    static const GVecGen4 ops[4] = { { .fniv = gen_sclamp_vec,
...
static void gen_uclamp_vec(unsigned vece, TCGv_vec d, TCGv_vec n, TCGv_vec m,
                           TCGv_vec a)
{
...
static void gen_uclamp(unsigned vece, uint32_t d, uint32_t n, uint32_t m,
                       uint32_t a, uint32_t oprsz, uint32_t maxsz)
{
    static const TCGOpcode vecop[] = { INDEX_op_umin_vec, INDEX_op_umax_vec,
                                       0 };
    static const GVecGen4 ops[4] = { { .fniv = gen_uclamp_vec,
