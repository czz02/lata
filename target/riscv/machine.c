...
static const VMStateDescription vmstate_pmp_entry = {
    ...
    .fields = (VMStateField[]){ VMSTATE_UINTTL(addr_reg, pmp_entry_t),
...
static const VMStateDescription vmstate_pmp = {
    ...
    .fields = (VMStateField[]){ VMSTATE_STRUCT_ARRAY(
                                    env.pmp_state.pmp, RISCVCPU, MAX_RISCV_PMPS,
...
static const VMStateDescription vmstate_hyper = {
    ...
    .needed = hyper_needed,
    .fields = (VMStateField[]){ VMSTATE_UINTTL(env.hstatus, RISCVCPU),
...
static const VMStateDescription vmstate_vector = {
    ...
    .fields =
        (VMStateField[]){
            ...
            VMSTATE_BOOL(env.vill, RISCVCPU), VMSTATE_END_OF_LIST() }
};
...
static const VMStateDescription vmstate_pointermasking = {
    ...
    .fields = (VMStateField[]){ VMSTATE_UINTTL(env.mmte, RISCVCPU),
...
static const VMStateDescription vmstate_rv128 = {
    ...
    .minimum_version_id = 1,
    .needed = rv128_needed,
    .fields = (VMStateField[]){ VMSTATE_UINTTL_ARRAY(env.gprh, RISCVCPU, 32),
...
static const VMStateDescription vmstate_kvmtimer = {
    ...
    .fields = (VMStateField[]){ VMSTATE_UINT64(env.kvm_timer_time, RISCVCPU),
...
static const VMStateDescription vmstate_smstateen = {
    ...
    .fields = (VMStateField[]){ VMSTATE_UINT64_ARRAY(env.mstateen, RISCVCPU, 4),
...
static const VMStateDescription vmstate_envcfg = {
    ...
    .fields = (VMStateField[]){ VMSTATE_UINT64(env.menvcfg, RISCVCPU),
...
static const VMStateDescription vmstate_pmu_ctr_state = {
    ...
    .minimum_version_id = 1,
    .needed = pmu_needed,
    .fields = (VMStateField[]){ VMSTATE_UINTTL(mhpmcounter_val, PMUCTRState),
...
static const VMStateDescription vmstate_jvt = {
    ...
    .minimum_version_id = 1,
    .needed = jvt_needed,
    .fields = (VMStateField[]){ VMSTATE_UINTTL(env.jvt, RISCVCPU),
                                VMSTATE_END_OF_LIST() }
};
...
const VMStateDescription vmstate_riscv_cpu = {
    ...
    .fields =
        (VMStateField[]){
            ...
            VMSTATE_END_OF_LIST() },
    .subsections =
        (const VMStateDescription *[]){ &vmstate_pmp, &vmstate_hyper,
                                        &vmstate_vector,
                                        &vmstate_pointermasking, &vmstate_rv128,
#ifdef CONFIG_KVM
                                        &vmstate_kvmtimer,
#endif
                                        &vmstate_envcfg, &vmstate_debug,
                                        &vmstate_smstateen, &vmstate_jvt, NULL }
};
