...
#define DEF_VAVG(BITS)                                                     \
    ...
    {                                                                      \
        ...
        for (i = 0; i < (128 / BITS); i++) {                               \
            const int32_t a =                                              \
                (int##BITS##_t)s390_vec_read_element##BITS(v2, i);         \
            const int32_t b =                                              \
                (int##BITS##_t)s390_vec_read_element##BITS(v3, i);         \
                                                                           \
    ...
    {                                                                      \
        ...
        for (i = 0; i < (128 / BITS); i++) {                               \
            ...
            const int32_t b =                                              \
                (int##BITS##_t)s390_vec_read_element##BITS(v3, i);         \
            const int32_t c =                                              \
                (int##BITS##_t)s390_vec_read_element##BITS(v4, i);         \
                                                                           \
...
#define DEF_VMAE(BITS, TBITS)                                              \
    ...
    {                                                                      \
        ...
        for (i = 0, j = 0; i < (128 / TBITS); i++, j += 2) {               \
            int##TBITS##_t a =                                             \
                (int##BITS##_t)s390_vec_read_element##BITS(v2, j);         \
            int##TBITS##_t b =                                             \
                (int##BITS##_t)s390_vec_read_element##BITS(v3, j);         \
...
#define DEF_VERIM(BITS)                                                     \
    ...
    {                                                                       \
        ...
        for (i = 0; i < (128 / BITS); i++) {                                \
            ...
            const uint##BITS##_t d =                                        \
                (a & ~mask) | (rol##BITS(b, count) & mask);                 \
                                                                            \
...
void HELPER(gvec_vsl)(void *v1, const void *v2, uint64_t count, uint32_t desc)
{
...
void HELPER(gvec_vsra)(void *v1, const void *v2, uint64_t count, uint32_t desc)
{
...
void HELPER(gvec_vsrl)(void *v1, const void *v2, uint64_t count, uint32_t desc)
{
