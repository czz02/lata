...
#define GET_FIELD_SPs(x, a, b) \
    sign_extend(GET_FIELD_SP(x, a, b), ((b) - (a) + 1))
...
{
    tcg_gen_st_i64(cpu_fpr[src / 2], cpu_env,
                   offsetof(CPUSPARCState, qt0) +
                       offsetof(CPU_QuadU, ll.upper));
    tcg_gen_st_i64(cpu_fpr[src / 2 + 1], cpu_env,
                   offsetof(CPUSPARCState, qt0) +
...
{
    tcg_gen_ld_i64(cpu_fpr[dst / 2], cpu_env,
                   offsetof(CPUSPARCState, qt0) +
                       offsetof(CPU_QuadU, ll.upper));
    tcg_gen_ld_i64(cpu_fpr[dst / 2 + 1], cpu_env,
                   offsetof(CPUSPARCState, qt0) +
                       offsetof(CPU_QuadU, ll.lower));
}

static void gen_store_fpr_Q(DisasContext *dc, unsigned int dst, TCGv_i64 v1,
                            TCGv_i64 v2)
{
    dst = QFPREG(dst);
...
static void gen_goto_tb(DisasContext *s, int tb_num, target_ulong pc,
                        target_ulong npc)
{
...
static void gen_op_addx_int(DisasContext *dc, TCGv dst, TCGv src1, TCGv src2,
                            int update_cc)
{
    TCGv_i32 carry_32;
    TCGv carry;
...
static void gen_op_subx_int(DisasContext *dc, TCGv dst, TCGv src1, TCGv src2,
                            int update_cc)
{
    TCGv_i32 carry_32;
    TCGv carry;
...
static void gen_op_mulscc(TCGv dst, TCGv src1, TCGv src2)
{
    ...
    */
    ...
    tcg_gen_movcond_tl(TCG_COND_EQ, cpu_cc_src2, r_temp, zero, zero,
                       cpu_cc_src2);
...
static void gen_branch2(DisasContext *dc, target_ulong pc1, target_ulong pc2,
                        TCGv r_cond)
{
...
static void gen_branch_n(DisasContext *dc, target_ulong pc1)
{
    ...
    if (npc & 3) {
        ...
        case DYNAMIC_PC_LOOKUP:
            ...
            tcg_gen_movcond_tl(TCG_COND_NE, cpu_npc, cpu_cond,
                               tcg_constant_tl(0), tcg_constant_tl(pc1),
                               cpu_npc);
            dc->pc = npc;
            break;
        default:
                        ...
                        DisasContext *dc)
{
    ...
    static int logic_cond[16] = {
        TCG_COND_NEVER,  TCG_COND_EQ, /* eq:  Z */
        ...
        TCG_COND_ALWAYS, TCG_COND_NE, /* ne:  !Z */
...
static const int gen_tcg_cond_reg[8] = {
    -1, TCG_COND_NE, TCG_COND_GT, TCG_COND_GE,
    -1, TCG_COND_EQ, TCG_COND_LE, TCG_COND_LT,
};
...
static void gen_fop_QQ(DisasContext *dc, int rd, int rs, void (*gen)(TCGv_ptr))
{
...
static void gen_swap(DisasContext *dc, TCGv dst, TCGv src, TCGv addr,
...
static void gen_ld_asi(DisasContext *dc, TCGv dst, TCGv addr, int insn,
                       MemOp memop)
{
...
static void gen_st_asi(DisasContext *dc, TCGv src, TCGv addr, int insn,
                       MemOp memop)
{
    DisasASI da = get_asi(dc, insn, memop);
...
static void gen_swap_asi(DisasContext *dc, TCGv dst, TCGv src, TCGv addr,
                         int insn)
{
...
static void gen_cas_asi(DisasContext *dc, TCGv addr, TCGv cmpv, int insn,
                        int rd)
{
    DisasASI da = get_asi(dc, insn, MO_TEUL);
    TCGv oldv;
...
#ifdef TARGET_SPARC64
static void gen_ldf_asi(DisasContext *dc, TCGv addr, int insn, int size, int rd)
{
...
static void gen_stf_asi(DisasContext *dc, TCGv addr, int insn, int size, int rd)
{
    DisasASI da = get_asi(dc, insn, (size == 4 ? MO_TEUL : MO_TEUQ));
    TCGv_i32 d32;
    ...
    case GET_ASI_DIRECT:
        ...
        case 16:
            ...
            tcg_gen_addi_tl(addr, addr, 8);
            tcg_gen_qemu_st_i64(cpu_fpr[rd / 2 + 1], addr, da.mem_idx,
                                da.memop);
            break;
        default:
            g_assert_not_reached();
...
static void gen_stda_asi(DisasContext *dc, TCGv hi, TCGv addr, int insn, int rd)
{
    DisasASI da = get_asi(dc, insn, MO_TEUQ);
...
static void gen_casx_asi(DisasContext *dc, TCGv addr, TCGv cmpv, int insn,
                         int rd)
{
    DisasASI da = get_asi(dc, insn, MO_TEUQ);
    TCGv oldv;
...
static void gen_fmovd(DisasContext *dc, DisasCompare *cmp, int rd, int rs)
{
    ...
    tcg_gen_movcond_i64(cmp->cond, dst, cmp->c1, cmp->c2,
                        gen_load_fpr_D(dc, rs), gen_load_fpr_D(dc, rd));
    gen_store_fpr_D(dc, rd, dst);
}
...
static void gen_edge(DisasContext *dc, TCGv dst, TCGv s1, TCGv s2, int width,
                     bool cc, bool left)
{
    TCGv lo1, lo2;
...
static void disas_sparc_insn(DisasContext *dc, unsigned int insn)
{
    ...
    case 0: /* branches/sethi */
    {
        ...
        {
            target =
                GET_FIELD_SP(insn, 0, 13) | (GET_FIELD_SP(insn, 20, 21) << 14);
    ...
    case 2: /* FPU & Logical Operations */
    {
        ...
        if (xop == 0x3a) { /* generate trap */
...
#endif
                l1 = gen_new_label();
                tcg_gen_brcond_tl(tcg_invert_cond(cmp.cond), cmp.c1, cmp.c2,
                                  l1);
            }
            ...
            case 0x4: /* V9 rdtick */
            {
                ...
                gen_helper_tick_get_count(cpu_dst, cpu_env, r_tickptr, r_const);
                gen_store_gpr(dc, rd, cpu_dst);
            } break;
            case 0x5: /* V9 rdpc */
            {
            ...
            case 0: // tpc
            {
                ...
                tcg_gen_ld_tl(cpu_tmp0, r_tsptr, offsetof(trap_state, tpc));
            } break;
            case 1: // tnpc
            {
                TCGv_ptr r_tsptr;
                ...
                r_tsptr = tcg_temp_new_ptr();
                gen_load_trap_state_at_tl(r_tsptr, cpu_env);
                tcg_gen_ld_tl(cpu_tmp0, r_tsptr, offsetof(trap_state, tnpc));
            } break;
            case 2: // tstate
            {
                TCGv_ptr r_tsptr;
                ...
                r_tsptr = tcg_temp_new_ptr();
                gen_load_trap_state_at_tl(r_tsptr, cpu_env);
                tcg_gen_ld_tl(cpu_tmp0, r_tsptr, offsetof(trap_state, tstate));
            } break;
            case 3: // tt
            {
                ...
                gen_load_trap_state_at_tl(r_tsptr, cpu_env);
                tcg_gen_ld32s_tl(cpu_tmp0, r_tsptr, offsetof(trap_state, tt));
            } break;
            case 4: // tick
            {
                TCGv_ptr r_tickptr;
...
#undef FMOVCC
            ...
            if (xop < 0x20) {
                ...
                case 0xe: /* udiv */
                    ...
                    if (xop & 0x10) {
                        ...
                        gen_helper_udiv(cpu_dst, cpu_env, cpu_src1, cpu_src2);
                    }
                    break;
                case 0xf: /* sdiv */
                    CHECK_IU_FEATURE(dc, DIV);
                    if (xop & 0x10) {
                        ...
                        gen_helper_sdiv(cpu_dst, cpu_env, cpu_src1, cpu_src2);
                    }
                    break;
                default:
                    goto illegal_insn;
                ...
                case 0x21: /* tsubcc */
                    ...
                    break;
                case 0x22: /* taddcctv */
                    gen_helper_taddcctv(cpu_dst, cpu_env, cpu_src1, cpu_src2);
                    gen_store_gpr(dc, rd, cpu_dst);
                    dc->cc_op = CC_OP_TADDTV;
                    break;
                case 0x23: /* tsubcctv */
                    gen_helper_tsubcctv(cpu_dst, cpu_env, cpu_src1, cpu_src2);
                    gen_store_gpr(dc, rd, cpu_dst);
                ...
                case 0x30: {
                    ...
                    case 0x10 ... 0x1f: /* implementation-dependent
                                           ...
                                           microSPARC II */
                        if ((rd == 0x13) &&
                            (dc->def->features & CPU_FEATURE_POWERDOWN)) {
                            /* LEON3 power-down */
                            save_state(dc);
                    ...
                    case 0x17: /* Tick compare */
...
#endif
                        {
                            ...
                            tcg_gen_xor_tl(cpu_tick_cmpr, cpu_src1, cpu_src2);
                            r_tickptr = tcg_temp_new_ptr();
                            tcg_gen_ld_ptr(r_tickptr, cpu_env,
                                           offsetof(CPUSPARCState, tick));
                    ...
                    case 0x18: /* System tick */
...
#endif
                        {
                            ...
                            tcg_gen_ld_ptr(r_tickptr, cpu_env,
                                           offsetof(CPUSPARCState, stick));
                            translator_io_start(&dc->base);
                            gen_helper_tick_set_count(r_tickptr, cpu_tmp0);
                            /* End TB to handle timer interrupt */
                            dc->base.is_jmp = DISAS_EXIT;
                        }
                        break;
                    case 0x19: /* System tick compare */
...
#endif
                        {
                            ...
                            tcg_gen_xor_tl(cpu_stick_cmpr, cpu_src1, cpu_src2);
                            r_tickptr = tcg_temp_new_ptr();
                            tcg_gen_ld_ptr(r_tickptr, cpu_env,
                                           offsetof(CPUSPARCState, stick));
                            translator_io_start(&dc->base);
                ...
                case 0x2c: /* V9 movcc */
                {
                    ...
                    tcg_gen_movcond_tl(cmp.cond, dst, cmp.c1, cmp.c2, cpu_src2,
                                       dst);
                    gen_store_gpr(dc, rd, dst);
                    break;
                }
    ...
    case 3: /* load/store instructions */
    {
        ...
        if (xop < 4 || (xop > 7 && xop < 0x14 && xop != 0x0e) ||
            (xop > 0x17 && xop <= 0x1d) || (xop > 0x2c && xop <= 0x33) ||
            xop == 0x1f || xop == 0x3d) {
            ...
            case 0x0: /* ld, V9 lduw, load unsigned word */
                ...
                tcg_gen_qemu_ld_tl(cpu_val, cpu_addr, dc->mem_idx,
                                   MO_TEUL | MO_ALIGN);
                break;
            case 0x1: /* ldub, load unsigned byte */
                gen_address_mask(dc, cpu_addr);
                tcg_gen_qemu_ld_tl(cpu_val, cpu_addr, dc->mem_idx, MO_UB);
                break;
            ...
            case 0x3: /* ldd, load double word */
                if (rd & 1)
                    ...
                    gen_address_mask(dc, cpu_addr);
                    t64 = tcg_temp_new_i64();
                    tcg_gen_qemu_ld_i64(t64, cpu_addr, dc->mem_idx,
                                        MO_TEUQ | MO_ALIGN);
            ...
            case 0x0f:
                ...
                gen_swap(dc, cpu_val, cpu_src1, cpu_addr, dc->mem_idx, MO_TEUL);
                break;
#if !defined(CONFIG_USER_ONLY) || defined(TARGET_SPARC64)
        ...
        skip_move:;
            ...
            case 0x20: /* ldf, load fpreg */
                gen_address_mask(dc, cpu_addr);
                cpu_dst_32 = gen_dest_fpr_F(dc);
                tcg_gen_qemu_ld_i32(cpu_dst_32, cpu_addr, dc->mem_idx,
                                    MO_TEUL | MO_ALIGN);
                gen_store_fpr_F(dc, rd, cpu_dst_32);
                break;
        ...
        } else if (xop < 8 || (xop >= 0x14 && xop < 0x18) || xop == 0xe ||
                   xop == 0x1e) {
            ...
            case 0x4: /* st, store word */
                gen_address_mask(dc, cpu_addr);
                tcg_gen_qemu_st_tl(cpu_val, cpu_addr, dc->mem_idx,
                                   MO_TEUL | MO_ALIGN);
                break;
            ...
            case 0x7: /* std, store double word */
                if (rd & 1)
                    ...
                    tcg_gen_qemu_st_i64(t64, cpu_addr, dc->mem_idx,
                                        MO_TEUQ | MO_ALIGN);
                }
                break;
#if !defined(CONFIG_USER_ONLY) || defined(TARGET_SPARC64)
            ...
            case 0x24: /* stf, store fpreg */
                ...
                tcg_gen_qemu_st_i32(cpu_src1_32, cpu_addr, dc->mem_idx,
                                    MO_TEUL | MO_ALIGN);
                break;
            case 0x25: /* stfsr, V9 stxfsr */
            {
                ...
                gen_address_mask(dc, cpu_addr);
                if (rd == 1) {
                    tcg_gen_qemu_st_tl(cpu_fsr, cpu_addr, dc->mem_idx,
                                       MO_TEUQ | MO_ALIGN);
                    break;
                }
#endif
...
void sparc_tcg_init(void)
{
    static const char gregnames[32][4] = {
        ...
        "o3", "o4", "o5", "o6", "o7", "l0", "l1", "l2", "l3", "l4", "l5",
    ...
    cpu_regwptr = tcg_global_mem_new_ptr(
        cpu_env, offsetof(CPUSPARCState, regwptr), "regwptr");
    ...
    cpu_regs[0] = NULL;
    for (i = 1; i < 8; ++i) {
        cpu_regs[i] = tcg_global_mem_new(
            cpu_env, offsetof(CPUSPARCState, gregs[i]), gregnames[i]);
    }

    for (i = 8; i < 32; ++i) {
        cpu_regs[i] = tcg_global_mem_new(
            cpu_regwptr, (i - 8) * sizeof(target_ulong), gregnames[i]);
    }

    for (i = 0; i < TARGET_DPREGS; i++) {
        cpu_fpr[i] = tcg_global_mem_new_i64(
            cpu_env, offsetof(CPUSPARCState, fpr[i]), fregnames[i]);
    }
}

void sparc_restore_state_to_opc(CPUState *cs, const TranslationBlock *tb,
                                const uint64_t *data)
{
