...
static const VMStateDescription vmstate_cpu_timer = {
    ...
    .fields = (VMStateField[]){ VMSTATE_UINT32(frequency, CPUTimer),
...
static const VMStateDescription vmstate_trap_state = {
    ...
    .version_id = 1,
    .minimum_version_id = 1,
    .fields = (VMStateField[]){ VMSTATE_UINT64(tpc, trap_state),
...
static const VMStateDescription vmstate_tlb_entry = {
    ...
    .version_id = 1,
    .minimum_version_id = 1,
    .fields = (VMStateField[]){ VMSTATE_UINT64(tag, SparcTLBEntry),
...
const VMStateDescription vmstate_sparc_cpu = {
    ...
    .fields =
        (VMStateField[]){
            ...
            VMSTATE_STRUCT_ARRAY(env.itlb, SPARCCPU, 64, 0, vmstate_tlb_entry,
                                 SparcTLBEntry),
            VMSTATE_STRUCT_ARRAY(env.dtlb, SPARCCPU, 64, 0, vmstate_tlb_entry,
                                 SparcTLBEntry),
