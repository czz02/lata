...
HexValue gen_round(Context *c, YYLTYPE *locp, HexValue *src,
                   HexValue *position);
...
HexValue gen_interleave(Context *c, YYLTYPE *locp, HexValue *odd,
                        HexValue *even);
