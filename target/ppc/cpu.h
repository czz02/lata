...
#define MMCR2_UREG_MASK                                                    \
    (MMCR2_FC1P0 | MMCR2_FC2P0 | MMCR2_FC3P0 | MMCR2_FC4P0 | MMCR2_FC5P0 | \
     MMCR2_FC6P0)
...
#define FPSCR_IX                                                     \
    ((1 << FPSCR_VXSNAN) | (1 << FPSCR_VXISI) | (1 << FPSCR_VXIDI) | \
     (1 << FPSCR_VXZDZ) | (1 << FPSCR_VXIMZ) | (1 << FPSCR_VXVC) |   \
     (1 << FPSCR_VXSOFT) | (1 << FPSCR_VXSQRT) | (1 << FPSCR_VXCVI))
...
#define FP_EX_CLEAR_BITS                                                       \
    (FP_FX | FP_OX | FP_UX | FP_ZX | FP_XX | FP_VXSNAN | FP_VXISI | FP_VXIDI | \
     FP_VXZDZ | FP_VXIMZ | FP_VXVC | FP_VXSOFT | FP_VXSQRT | FP_VXCVI)

/* FPSCR bits that can be set by mtfsf, mtfsfi and mtfsb1 */
#define FPSCR_MTFS_MASK \
    (~(MAKE_64BIT_MASK(36, 28) | PPC_BIT(28) | FP_FEX | FP_VX | PPC_BIT(52)))
...
#define MMUCSR0_TLBFI \
    (MMUCSR0_TLB0FI | MMUCSR0_TLB1FI | MMUCSR0_TLB2FI | MMUCSR0_TLB3FI)
...
struct PPCVirtualHypervisorClass {
    ...
    void (*unmap_hptes)(PPCVirtualHypervisor *vhyp,
                        const ppc_hash_pte64_t *hptes, hwaddr ptex, int n);
...
#define PPC_TCG_INSNS                                                        \
    (PPC_INSNS_BASE | PPC_64B | PPC_64BX | PPC_64H | PPC_WAIT | PPC_MFTB |   \
     PPC_ISEL | PPC_POPCNTB | PPC_STRING | PPC_FLOAT | PPC_FLOAT_EXT |       \
     PPC_FLOAT_FSQRT | PPC_FLOAT_FRES | PPC_FLOAT_FRSQRTE |                  \
     PPC_FLOAT_FRSQRTES | PPC_FLOAT_FSEL | PPC_FLOAT_STFIWX | PPC_ALTIVEC |  \
     PPC_SPE | PPC_SPE_SINGLE | PPC_SPE_DOUBLE | PPC_MEM_TLBIA |             \
     PPC_MEM_TLBIE | PPC_MEM_TLBSYNC | PPC_MEM_SYNC | PPC_MEM_EIEIO |        \
     PPC_CACHE | PPC_CACHE_ICBI | PPC_CACHE_DCBZ | PPC_CACHE_DCBA |          \
     PPC_CACHE_LOCK | PPC_EXTERN | PPC_SEGMENT | PPC_6xx_TLB | PPC_40x_TLB | \
     PPC_SEGMENT_64B | PPC_SLBI | PPC_WRTEE | PPC_40x_EXCP | PPC_405_MAC |   \
     PPC_440_SPEC | PPC_BOOKE | PPC_MFAPIDI | PPC_TLBIVA | PPC_TLBIVAX |     \
     PPC_4xx_COMMON | PPC_40x_ICBT | PPC_RFMCI | PPC_RFDI | PPC_DCR |        \
     PPC_DCRX | PPC_POPCNTWD | PPC_CILDST)
...
#define PPC_TCG_INSNS2                                                        \
    (PPC2_BOOKE206 | PPC2_VSX | PPC2_PRCNTL | PPC2_DBRX | PPC2_ISA205 |       \
     PPC2_VSX207 | PPC2_PERM_ISA206 | PPC2_DIVE_ISA206 | PPC2_ATOMIC_ISA206 | \
     PPC2_FP_CVT_ISA206 | PPC2_FP_TST_ISA206 | PPC2_BCTAR_ISA207 |            \
     PPC2_LSQ_ISA207 | PPC2_ALTIVEC_207 | PPC2_ISA207S | PPC2_DFP |           \
     PPC2_FP_CVT_S64 | PPC2_TM | PPC2_PM_ISA206 | PPC2_ISA300 | PPC2_ISA310 | \
...
#define POWERPC_FAMILY(_name)                                                  \
    static void glue(glue(ppc_, _name), _cpu_family_class_init)(ObjectClass *, \
                                                                void *);       \
                                                                               \
    static const TypeInfo glue(glue(ppc_, _name), _cpu_family_type_info) = {   \
    ...
    {                                                                          \
        type_register_static(&glue(glue(ppc_, _name), _cpu_family_type_info)); \
    }                                                                          \
                                                                               \
