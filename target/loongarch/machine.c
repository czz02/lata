...
static const VMStateDescription vmstate_fpu_reg = {
    ...
    .fields =
        (VMStateField[]){ VMSTATE_UINT64(UD(0), VReg), VMSTATE_END_OF_LIST() }
};

#define VMSTATE_FPU_REGS(_field, _state, _start)                             \
    VMSTATE_STRUCT_SUB_ARRAY(_field, _state, _start, 32, 0, vmstate_fpu_reg, \
                             fpr_t)
...
static const VMStateDescription vmstate_fpu = {
    ...
    .minimum_version_id = 1,
    .needed = fpu_needed,
    .fields = (VMStateField[]){ VMSTATE_FPU_REGS(env.fpr, LoongArchCPU, 0),
...
static const VMStateDescription vmstate_lsxh_reg = {
    ...
    .minimum_version_id = 1,
    .fields =
        (VMStateField[]){ VMSTATE_UINT64(UD(1), VReg), VMSTATE_END_OF_LIST() }
};

#define VMSTATE_LSXH_REGS(_field, _state, _start)                             \
    VMSTATE_STRUCT_SUB_ARRAY(_field, _state, _start, 32, 0, vmstate_lsxh_reg, \
                             fpr_t)
...
static const VMStateDescription vmstate_lsx = {
    ...
    .minimum_version_id = 1,
    .needed = lsx_needed,
    .fields = (VMStateField[]){ VMSTATE_LSXH_REGS(env.fpr, LoongArchCPU, 0),
                                VMSTATE_END_OF_LIST() },
};
...
const VMStateDescription vmstate_tlb = {
    ...
    .fields = (VMStateField[]){ VMSTATE_UINT64(tlb_misc, LoongArchTLB),
...
const VMStateDescription vmstate_loongarch_cpu = {
    ...
    .minimum_version_id = 1,
    .fields =
        (VMStateField[]){ VMSTATE_UINTTL_ARRAY(env.gpr, LoongArchCPU, 32),
                          ...
                          /* TLB */
                          VMSTATE_STRUCT_ARRAY(env.tlb, LoongArchCPU,
                                               LOONGARCH_TLB_MAX, 0,
                                               vmstate_tlb, LoongArchTLB),

                          VMSTATE_END_OF_LIST() },
    .subsections =
        (const VMStateDescription *[]){ &vmstate_fpu, &vmstate_lsx, NULL }
};
